...
<g:if test="${validate != "false" }">
	...
	<g:else>
		<g:if test="${executionInstanceList}">
			...
			<div id="combinedReportButton">
				<g:link onclick="return combinedExcelReportGeneration('${executionIdList}')" >
					<span class = "buttons"><input type="button" style="font-weight: bold;" value="Generate Combined Report"><img src="../images/excel.png"  title = " Download Combined Report(Excel)" style="padding-left: 5px"/></span>
				</g:link>
			</div>
		</g:if>
		<g:else>
