...
<html>
	<head>
		...
		//window.onload = showTemplate;
		</script>
	</head>
	<body>
		<a href="#create-deviceTemplate" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-deviceTemplate" class="content scaffold-create" role="main">
