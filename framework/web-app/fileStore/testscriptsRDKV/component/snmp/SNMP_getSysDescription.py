...
<xml>
  ...
  <name>SNMP_getSysDescription</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>This test gets the system description of the host</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>CT_SNMP_04</test_case_id>
    <test_objective>To get the system description using snmpwalk command
</test_objective>
...
TestManager GUI will publish the result as PASS in Execution/Console page of Test Manager"
    ...
    <test_script>SNMP_getSysDescription</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'SNMP_getSysDescription');
