...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>5</version>
  <name>DTCP_SetInvalidLogLevel_16</name>
  <primitive_test_id/>
  <primitive_test_name>DTCP_Comp_Test</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>To set DTCP Manager's logging verbosity level to an invalid value.
TestType: Negative
TestcaseID: CT_DTCP_16</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_DTCP_16</test_case_id>
    <test_objective>To set DTCP Manager's logging verbosity level to an invalid value.</test_objective>
    ...
    <input_parameters>"level":50</input_parameters>
...
4. TM will receive and display the result.</automation_approch>
    ...
    <test_script>DTCP_SetInvalidLogLevel_16</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'DTCP_SetInvalidLogLevel_16');
...
if "SUCCESS" in loadmodulestatus.upper():
  ...
  #Calling setloglevel
  setLogLevel(tdkTestObj,'FAILURE',kwargs={"level":50})
