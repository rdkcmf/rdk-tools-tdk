...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>8</version>
  <name>DTCP_GetNumSessions_09</name>
  <primitive_test_id/>
  <primitive_test_name>DTCP_Comp_Test</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>To retrieve the total number of active sessions for the specified device type.
TestType: Positive
TestcaseID: CT_DTCP_09</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_DTCP_09</test_case_id>
    <test_objective>To retrieve the total number of active sessions for the specified device type.</test_objective>
    ...
    <input_parameters>'deviceType':2</input_parameters>
    <automation_approch>1.TM loads DTCP_agent via the test agent. 
2.The stub will invokes the RPC method for to get num of active session.
...
4. TM will receive and display the result.</automation_approch>
    ...
    <test_script>DTCP_GetNumSessions_09</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'DTCP_GetNumSessions_09');
...
if "SUCCESS" in loadmodulestatus.upper():
  ...
  #Calling DTCPMgrGetNumSessions for ALL device Types
  getNumSessions(tdkTestObj,expectedresult,kwargs={'deviceType':2})
