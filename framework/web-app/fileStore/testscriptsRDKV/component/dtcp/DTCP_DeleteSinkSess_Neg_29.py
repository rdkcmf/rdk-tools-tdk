...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>DTCP_DeleteSinkSess_Neg_29</name>
  <primitive_test_id/>
  <primitive_test_name>DTCP_Comp_Test</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>To stop a null DTCP-IP sink session.
TestType: Negative
TestcaseID: CT_DTCP_29</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_DTCP_29</test_case_id>
    <test_objective>To stop a null DTCP-IP sink session.</test_objective>
...
4. TM will receive and display the result.</automation_approch>
    ...
    <test_script>DTCP_DeleteSinkSess_Neg_29</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'DTCP_DeleteSinkSess_Neg_29');
