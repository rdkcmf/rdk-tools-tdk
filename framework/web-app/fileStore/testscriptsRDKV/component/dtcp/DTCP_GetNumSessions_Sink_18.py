...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>DTCP_GetNumSessions_Sink_18</name>
  <primitive_test_id/>
  <primitive_test_name>DTCP_Comp_Test</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>To retrieve the total number of active sink sessions.
TestType: Positive
TestcaseID: CT_DTCP_18</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_DTCP_18</test_case_id>
    <test_objective>To retrieve the total number of active sink sessions.</test_objective>
    ...
    <input_parameters>deviceType':1</input_parameters>
...
4. TM will receive and display the result.</automation_approch>
    ...
    <test_script>DTCP_GetNumSessions_Sink_18</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'DTCP_GetNumSessions_Sink_18');
...
if "SUCCESS" in loadmodulestatus.upper():
  ...
  getNumSessions(tdkTestObj,expectedresult,kwargs={'deviceType':1})
