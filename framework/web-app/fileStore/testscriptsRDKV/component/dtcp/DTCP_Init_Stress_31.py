...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>DTCP_Init_Stress_31</name>
  <primitive_test_id/>
  <primitive_test_name>DTCP_Comp_Test</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>To initialize the DTCP-IP Manager sub-system multiple times.
TestType: Positive
TestcaseID - CT_DTCP_31</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_DTCP_31</test_case_id>
    <test_objective>To initialize the DTCP-IP Manager sub-system multiple times.</test_objective>
...
4. TM will receive and display the result.</automation_approch>
    ...
    <test_script>DTCP_Init_Stress_31</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'DTCP_Init_Stress_31');
...
if "SUCCESS" in loadmodulestatus.upper():
  ...
  #Calling DTCPMgr Init 50 times
  for n in range(0,50):
      init(tdkTestObj,'SUCCESS');
