...
TestcaseID: CT_DTCP_21</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_DTCP_21</test_case_id>
    <test_objective>To stop DTCP-IP source without adding AKE reques listeners with StartSource()</test_objective>
...
4. TM will receive and display the result.</automation_approch>
    ...
    <test_script>DTCP_StopWithoutStartSrc_21</test_script>
    <skipped>No</skipped>
...
import tdklib;
from dtcp import init,setLogLevel,stopSource;
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'DTCP_StopWithoutStartSrc_21');
...
if "SUCCESS" in loadmodulestatus.upper():
  ...
  #Pre-cond: DTCPMgrInit,setLogLevel
