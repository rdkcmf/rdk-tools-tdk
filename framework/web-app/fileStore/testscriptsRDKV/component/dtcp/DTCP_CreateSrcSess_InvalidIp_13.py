...
TestcaseID: CT_DTCP_13</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_DTCP_13</test_case_id>
    <test_objective>To create a new authenticated session with a remote DTCP-IP sink using invalid sink IP address.</test_objective>
    <test_type>Negative</test_type>
    <test_setup>XG1</test_setup>
    <pre_requisite>DTCPMgrInitialize</pre_requisite>
    <api_or_interface_used>dtcp_result_t DTCPMgrCreateSourceSession(char *sinkIpAddress, int key_label, int PCPPacketSize, int maxPacketSize, DTCP_SESSION_HANDLE *handle);</api_or_interface_used>
    <input_parameters>"sinkIp":'0.42.42.42'</input_parameters>
...
4. TM will receive and display the result.</automation_approch>
    ...
    <test_script>DTCP_CreateSrcSess_InvalidIp_13</test_script>
    <skipped>No</skipped>
