...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <status>FREE</status>
  <synopsis>To process null sink and source session handles.
TestType: Negative   
TestcaseID: CT_DTCP_26</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_DTCP_26</test_case_id>
    <test_objective>To process null sink and source session handles.</test_objective>
    <test_type>Negative</test_type>
    <test_setup>XG1</test_setup>
    <pre_requisite>DTCPMgrInitialize</pre_requisite>
    <api_or_interface_used>dtcp_result_t DTCPMgrProcessPacket(DTCP_SESSION_HANDLE session, DTCPIP_Packet *packet);</api_or_interface_used>
...
4. TM will receive and display the result.</automation_approch>
    ...
    <test_script>DTCP_ProcessPacket_Neg_26</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'DTCP_ProcessPacket_Neg_26');
