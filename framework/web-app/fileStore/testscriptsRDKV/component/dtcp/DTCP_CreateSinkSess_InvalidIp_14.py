...
TestcaseID: CT_DTCP_14</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_DTCP_14</test_case_id>
    <test_objective>To create a new authenticated session with a remote DTCP-IP source with an invalid source IP address.</test_objective>
...
dtcp_result_t DTCPMgrStopSource(void);</api_or_interface_used>
    <input_parameters>'srcIp':'0.42.42.42'</input_parameters>
...
4. TM will receive and display the result.</automation_approch>
    ...
    <test_script>DTCP_CreateSinkSess_InvalidIp_14</test_script>
    <skipped>No</skipped>
...
if "SUCCESS" in loadmodulestatus.upper():
  ...
  result = dtcp.startSource(tdkTestObj,expectedresult,kwargs={'ifName':'lo','port':5006})
  if expectedresult in result:
        #Calling CreateSinkSession
        result=dtcp.createSinkSession(tdkTestObj,'FAILURE',kwargs={'srcIp':'0.42.42.42','srcPort':5006,'uniqueKey':0,'maxPacketSize':4096})
