...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>17</version>
  <name>DTCP_GetSrcSessInfo_10</name>
  <primitive_test_id/>
  <primitive_test_name>DTCP_Comp_Test</primitive_test_name>
  <primitive_test_version>3</primitive_test_version>
  <status>FREE</status>
  <synopsis>To retrieve information related to an active source session.
TestType: Positive	
TestcaseID: CT_DTCP_10</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_DTCP_10</test_case_id>
    <test_objective>To retrieve information related to an active source session.</test_objective>
...
2.The stub will invokes the RPC method for to get session info
...
4. TM will receive and display the result.</automation_approch>
    ...
    <test_script>DTCP_GetSrcSessInfo_10</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'DTCP_GetSrcSessInfo_10');
...
if "SUCCESS" in loadmodulestatus.upper():
  ...
  dtcp.startSource(tdkTestObj,expectedresult,kwargs={'ifName':'lo','port':5013})
