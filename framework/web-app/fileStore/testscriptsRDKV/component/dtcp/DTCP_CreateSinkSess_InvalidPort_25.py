...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>DTCP_CreateSinkSess_InvalidPort_25</name>
  <primitive_test_id/>
  <primitive_test_name>DTCP_Comp_Test</primitive_test_name>
  <primitive_test_version>3</primitive_test_version>
  <status>FREE</status>
  <synopsis>To create a new authenticated session with a remote DTCP-IP source using invalid TCP/IP port.
TestType: Negative		
TestcaseID: CT_DTCP_25</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_DTCP_25</test_case_id>
    <test_objective>To create a new authenticated session with a remote DTCP-IP source using invalid TCP/IP port.</test_objective>
    <test_type>Negative</test_type>
    <test_setup>XG1</test_setup>
    <pre_requisite>DTCPMgrInitialize</pre_requisite>
    <api_or_interface_used>dtcp_result_t DTCPMgrInitialize(void);
...
dtcp_result_t DTCPMgrStopSource(void);</api_or_interface_used>
    <input_parameters>srcIp':'127.0.0.1','srcPort':0,'uniqueKey':0,'maxPacketSize':4096</input_parameters>
...
4. TM will receive and display the result.</automation_approch>
    ...
    <test_script>DTCP_CreateSinkSess_InvalidPort_25</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'DTCP_CreateSinkSess_InvalidPort_25');
...
if "SUCCESS" in loadmodulestatus.upper():
  ...
  result = dtcp.startSource(tdkTestObj,expectedresult,kwargs={'ifName':'lo','port':5007})
