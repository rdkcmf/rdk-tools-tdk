...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>11</version>
  <name>DTCP_StartStopSrc_MultiIface_17</name>
  <primitive_test_id/>
  <primitive_test_name>DTCP_Comp_Test</primitive_test_name>
  <primitive_test_version>3</primitive_test_version>
  <status>FREE</status>
  <synopsis>To start and stop DTCP-IP source on multiple interfaces and port number.
TestType: Positive
TestcaseID: CT_DTCP_17</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_DTCP_17</test_case_id>
    <test_objective>To start and stop DTCP-IP source on multiple interfaces and port number.</test_objective>
...
dtcp_result_t DTCPMgrStopSource(void);</api_or_interface_used>
    <input_parameters>ifName':["lan0","lo","eth1"],'port':[5000,5010,8080]</input_parameters>
...
4. TM will receive and display the result.</automation_approch>
    ...
    <test_script>DTCP_StartStopSrc_MultiIface_17</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'DTCP_StartStopSrc_MultiIface_17')
