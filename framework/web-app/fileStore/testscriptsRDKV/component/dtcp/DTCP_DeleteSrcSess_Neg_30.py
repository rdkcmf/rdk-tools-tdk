...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>DTCP_DeleteSrcSess_Neg_30</name>
  <primitive_test_id/>
  <primitive_test_name>DTCP_Comp_Test</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>To stop a null DTCP-IP source session.
TestType: Negative
TestcaseID: CT_DTCP_30</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_DTCP_30</test_case_id>
    <test_objective>To stop a null DTCP-IP source session.</test_objective>
    <test_type>Negative</test_type>
    <test_setup>XG1</test_setup>
    <pre_requisite>DTCPMgrInitialize</pre_requisite>
    <api_or_interface_used>dtcp_result_t DTCPMgrDeleteDTCPSession(DTCP_SESSION_HANDLE session);</api_or_interface_used>
    <input_parameters>session=0</input_parameters>
...
4. TM will receive and display the result.</automation_approch>
    ...
    <test_script>DTCP_DeleteSrcSess_Neg_30</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'DTCP_DeleteSrcSess_Neg_30');
