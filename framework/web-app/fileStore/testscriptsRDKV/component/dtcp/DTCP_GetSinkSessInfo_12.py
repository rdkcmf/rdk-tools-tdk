...
TestcaseID: CT_DTCP_12</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_DTCP_12</test_case_id>
    <test_objective>To retrieve information related to an active sink session.</test_objective>
    <test_type>Positive</test_type>
    <test_setup>XG1</test_setup>
    <pre_requisite>DTCPMgrInitialize, DTCPMgrCreateSinkSession</pre_requisite>
...
4. TM will receive and display the result.</automation_approch>
    ...
    <test_script>DTCP_GetSinkSessInfo_12</test_script>
    <skipped>No</skipped>
...
if "SUCCESS" in loadmodulestatus.upper():
  ...
  dtcp.startSource(tdkTestObj,expectedresult,kwargs={'ifName':'lo','port':5012})
  result = tdkTestObj.getResult();
  if "SUCCESS" in result:
        dtcp.createSinkSession(tdkTestObj,expectedresult,kwargs={'srcIp':'127.0.0.1','srcPort':5012,'uniqueKey':0,'maxPacketSize':4096})
