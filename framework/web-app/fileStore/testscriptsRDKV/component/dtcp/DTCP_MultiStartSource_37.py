...
TestcaseID: CT_DTCP_37</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_DTCP_37</test_case_id>
    <test_objective>To start multiple DTCP-IP source listeners on different interfaces and ports.</test_objective>
...
dtcp_result_t DTCPMgrStopSource(void);</api_or_interface_used>
    <input_parameters>ifName':'lan0','port':[6000...6059]</input_parameters>
...
4. TM will receive and display the result.</automation_approch>
    ...
    <test_script>DTCP_MultiStartSource_37</test_script>
    <skipped>Yes</skipped>
