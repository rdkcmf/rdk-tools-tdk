...
TestcaseID: CT_DTCP_23</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_DTCP_23</test_case_id>
    <test_objective>To start DTCP-IP source on an invalid interface name.</test_objective>
    ...
    <input_parameters>ifName':'127.0.0.1','port':5000</input_parameters>
...
4. TM will receive and display the result.</automation_approch>
    ...
    <test_script>DTCP_StartSource_InvalidIfName_23</test_script>
    <skipped>No</skipped>
...
if "SUCCESS" in loadmodulestatus.upper():
  ...
  startSource(tdkTestObj,'FAILURE',kwargs={'ifName':'127.0.0.1','port':5019})
