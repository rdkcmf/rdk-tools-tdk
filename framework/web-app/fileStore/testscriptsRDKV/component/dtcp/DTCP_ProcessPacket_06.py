...
TestcaseID: CT_DTCP_06</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_DTCP_06</test_case_id>
    <test_objective>To process(encrypt) the provided buffers and create a DTCP-IP packet and return decrypted buffers.</test_objective>
...
2.The stub will invokes the RPC method for to process DTCP packet
...
4. TM will receive and display the result.</automation_approch>
    ...
    <test_script>DTCP_ProcessPacket_06</test_script>
    <skipped>No</skipped>
    <release_version>M30</release_version>
    <remarks>Renamed from DTCP_ProcessSrcPacket_06 to DTCP_ProcessPacket_06</remarks>
  </test_cases>
  <script_tags>
