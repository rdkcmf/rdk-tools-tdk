...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <status>FREE</status>
  <synopsis>To start DTCP-IP source and begins listening for AKE requests on the specified interface and port number.
TestType: Positive
TestcaseID: CT_DTCP_02</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_DTCP_02</test_case_id>
    <test_objective>To start DTCP-IP source and begins listening for AKE requests on the specified interface and port number.</test_objective>
...
2.The stub will invokes the RPC method  to start source.
...
4. TM will receive and display the result.</automation_approch>
    ...
    <test_script>DTCP_StartSource_02</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'DTCP_StartSource_02');
...
if "SUCCESS" in loadmodulestatus.upper():
  ...
  startSource(tdkTestObj,expectedresult,kwargs={'ifName':'lo','port':5018})
