...
TestcaseID: CT_DTCP_33</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_DTCP_33</test_case_id>
    <test_objective>To create a new authenticated source session with a remote DTCP-IP sink without invoking StartSource().</test_objective>
...
dtcp_result_t DTCPMgrDeleteDTCPSession(DTCP_SESSION_HANDLE session);</api_or_interface_used>
    <input_parameters>sinkIp':ip,'keyLabel':0,'pcpPacketSize':0,'maxPacketSize':4096</input_parameters>
...
4. TM will receive and display the result.</automation_approch>
    ...
    <test_script>DTCP_CreateSrcSessWithoutStartSrc_33</test_script>
    <skipped>No</skipped>
