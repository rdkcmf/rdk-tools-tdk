...
TestcaseID: CT_DTCP_38</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_DTCP_38</test_case_id>
    <test_objective>To create and remove multiple AKE request listeners using startsource/stopsource</test_objective>
...
dtcp_result_t DTCPMgrStopSource(void);</api_or_interface_used>
    <input_parameters>ifName':'lan0','port':[8000,8001,8002,8003,8004]</input_parameters>
...
4. TM will receive and display the result.</automation_approch>
    ...
    <test_script>DTCP_StopAllSources_38</test_script>
    <skipped>No</skipped>
