...
TestcaseID: CT_DTCP_04</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_DTCP_04</test_case_id>
    <test_objective>To create a new authenticated session with a remote DTCP-IP sink.</test_objective>
...
2.The stub will invokes the RPC method for to create source session.
...
4. TM will receive and display the result.</automation_approch>
    ...
    <test_script>DTCP_CreateSrcSess_04</test_script>
    <skipped>No</skipped>
