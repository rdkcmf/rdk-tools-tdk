...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <status>FREE</status>
  <synopsis>To create a new authenticated sink session with a remote DTCP-IP source without invoking StartSource().
TestType: Negative
TestcaseID: CT_DTCP_34</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_DTCP_34</test_case_id>
    <test_objective>To create a new authenticated sink session with a remote DTCP-IP source without invoking StartSource().</test_objective>
    ...
    <input_parameters>srcIp':ip,'srcPort':5000,'uniqueKey':0,'maxPacketSize':4096</input_parameters>
...
4. TM will receive and display the result.</automation_approch>
    ...
    <test_script>DTCP_CreateSinkSessWithoutStartSrc_34</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'DTCP_CreateSinkSessWithoutStartSrc_34');
...
if "SUCCESS" in loadmodulestatus.upper():
  ...
  #Pre-cond: Init,CreateSinkSession
