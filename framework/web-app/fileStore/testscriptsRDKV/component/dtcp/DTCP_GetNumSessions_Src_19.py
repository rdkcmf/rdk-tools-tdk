...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>DTCP_GetNumSessions_Src_19</name>
  <primitive_test_id/>
  <primitive_test_name>DTCP_Comp_Test</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>To retrieve the total number of active source sessions.
TestType: Positive
TestcaseID: CT_DTCP_19</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_DTCP_19</test_case_id>
    <test_objective>To retrieve the total number of active source sessions.</test_objective>
    ...
    <input_parameters>deviceType':0</input_parameters>
...
4. TM will receive and display the result.</automation_approch>
    ...
    <test_script>DTCP_GetNumSessions_Src_19</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'DTCP_GetNumSessions_Src_19')
...
if "SUCCESS" in loadmodulestatus.upper():
  ...
  getNumSessions(tdkTestObj,expectedresult,kwargs={'deviceType':0})
