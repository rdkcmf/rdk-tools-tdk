...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>DTCP_CreateSinkSessOnLoSrcIp_39</name>
  <primitive_test_id/>
  <primitive_test_name>DTCP_Comp_Test</primitive_test_name>
  <primitive_test_version>3</primitive_test_version>
  <status>FREE</status>
  <synopsis>To create a new authenticated sink session with loopback IP address as remote DTCP-IP source.
TestType: Positive
TestcaseID: CT_DTCP_39</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_DTCP_39</test_case_id>
    <test_objective>To create a new authenticated sink session with loopback IP address as remote DTCP-IP source.</test_objective>
...
dtcp_result_t DTCPMgrStopSource(void);</api_or_interface_used>
    <input_parameters>srcIp':'127.0.0.1','srcPort':5000,'uniqueKey':0,'maxPacketSize':4096</input_parameters>
...
4. TM will receive and display the result.</automation_approch>
    ...
    <test_script>DTCP_CreateSinkSessOnLoSrcIp_39</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'DTCP_CreateSinkSessOnLoSrcIp_39');
