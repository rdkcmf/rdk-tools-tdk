...
3.Invoke the api wifi_getRadioExtChannel() to get the secondary extension channel position for radio 5GHz.
...
sysObj.configureTestCase(ip,port,'WIFI_HAL_5GHzGetRadioExtChannel');
