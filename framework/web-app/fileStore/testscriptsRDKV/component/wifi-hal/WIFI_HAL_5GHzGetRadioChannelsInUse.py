...
3.Invoke wifi_getRadioPossibleChannels() api and get the list of radio possible channels for radio 1.
4.Invoke and wifi_getRadioChannelsInUse() api and get the list of radio channels in use for radio 1.
...
sysObj.configureTestCase(ip,port,'WIFI_HAL_5GHzGetRadioChannelsInUse');
...
if "SUCCESS" in loadmodulestatus1.upper() and loadmodulestatus2.upper():
	...
	#Giving the method name to invoke the api for getting possible Radio Channel. ie,wifi_getRadioPossibleChannels()
        ...
        if expectedresult in actualresult:
            ...
            print "TEST STEP 1: Get the possible Radio Channels for 5GHz";
		    ...
		    #Set the result status of execution
                    tdkTestObj.setResultStatus("SUCCESS");
                    print "TEST STEP 2: Get the possible Channels in use for 5GHz";
                    print "EXPECTED RESULT 2: Should get the Radio Channels in use for 5GHz";
