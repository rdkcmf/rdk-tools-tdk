...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>RdkService_FunctionalPerformance_Webkit_LoadURL</name>
  <primitive_test_id/>
...
4. Find the output by calculating the difference between above timestamps.</automation_approch>
    ...
    <test_script>RdkService_FunctionalPerformance_Webkit_LoadURL</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RdkService_FunctionalPerformance_Webkit_LoadURL');
