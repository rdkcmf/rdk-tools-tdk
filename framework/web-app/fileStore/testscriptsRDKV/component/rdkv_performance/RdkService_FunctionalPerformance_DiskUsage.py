...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>RdkService_FunctionalPerformance_DiskUsage</name>
  <primitive_test_id/>
...
2. From the command output strip the disk usage of the required partition and verify whether it is greater than 90%</automation_approch>
    ...
    <test_script>RdkService_FunctionalPerformance_DiskUsage</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RdkService_FunctionalPerformance_DiskUsage');
