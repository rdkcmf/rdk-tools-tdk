...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>RdkService_FunctionalPerformance_TopCommand_Output</name>
  <primitive_test_id/>
...
4. Verify any process has %MEM more than 90.
    ...
    <test_script>RdkService_FunctionalPerformance_TopCommand_Output</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RdkService_FunctionalPerformance_TopCommand_Output');
