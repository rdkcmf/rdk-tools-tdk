...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>MocaHal_Get_Remote_ActiveMoCAVersion_NC</name>
  <primitive_test_id/>
  <primitive_test_name>MocaHal_RemoteNode_GetActiveMoCAVersion</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To get the active moca version of the network co-ordinator</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_MOCA_HAL_51</test_case_id>
    <test_objective>To get the active moca version of the network co-ordinator</test_objective>
...
2 .Moca hal agent will invoke the api SoC_IMPL__RMH_RemoteNode_GetActiveMoCAVersion with node id of NC
3. Check the api call return value and return SUCCESS/FAILURE status.</automation_approch>
    ...
    <test_script>MocaHal_Get_Remote_ActiveMoCAVersion_NC</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
mocahalObj.configureTestCase(ip,port,'MocaHal_Get_Remote_ActiveMoCAVersion_NC');
