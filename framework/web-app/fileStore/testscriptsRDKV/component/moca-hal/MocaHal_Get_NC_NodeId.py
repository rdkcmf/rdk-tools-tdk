...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>MocaHal_Get_NC_NodeId</name>
  <primitive_test_id/>
  <primitive_test_name>MocaHal_GetNCNodeId</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To to get the node Id of the network coordinator</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_MOCA_HAL_28</test_case_id>
    <test_objective>To to get the node Id of the network coordinator</test_objective>
...
2 .Moca hal agent will invoke the api  SoC_IMPL__RMH_Network_GetNCNodeId 
...
Checkpoint 2 Verify that the node id is retrieved</expected_output>
    ...
    <test_script>MocaHal_Get_NC_NodeId</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
mocahalObj.configureTestCase(ip,port,'MocaHal_Get_NC_NodeId');
