...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_DS_137</test_case_id>
    <test_objective>Device Setting –  This test tries to set Stereo Mode to STEREO for SPDIF</test_objective>
...
6.Device_Settings_Agent will check the current stereo format with new stereo format set and expect it to fail.
...
TestMgr_DS_managerDeinitialize</test_stub_interface>
    <test_script>DS_setSPDIF_STEREOFormat_137</test_script>
    <skipped>No</skipped>
