...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>617</id>
  <version>1</version>
  <name>DS_SetCompression_NONE_67</name>
  <primitive_test_id>78</primitive_test_id>
  <primitive_test_name>DS_SetCompression</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>ALLOCATED</status>
  <synopsis>This test script Sets and gets the NONE Compression Format of Audio Test Case ID : CT_DS_67.Note:This script will return duplicates, If running second time without restarting agent. Agent process may lead to crash/restart.This is an issue with DS.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_DS_67</test_case_id>
    <test_objective>Device Setting –  Get and set  compression format to NONE</test_objective>
...
device::Manager::DeInitialize()</api_or_interface_used>
    <input_parameters>SetCompression : NONE Value :0</input_parameters>
...
TestMgr_DS_managerDeinitialize</test_stub_interface>
    <test_script>DS_SetCompression_NONE_67</test_script>
    <skipped>No</skipped>
