...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>615</id>
  <version>2</version>
  <name>DS_SetCompression_HEAVY_FORMAT_reboot_persist_65</name>
  <primitive_test_id>78</primitive_test_id>
  <primitive_test_name>DS_SetCompression</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>This test script Sets and gets the HEAVY Compression Format of Audio and check if is persisted after reboot Test Case ID : CT_DS_65.Note:This script will return duplicates, If running second time without restarting agent. Agent process may lead to crash/restart.This is an issue with DS.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_DS_65</test_case_id>
...
device::Manager::DeInitialize()</api_or_interface_used>
    <input_parameters>SetCompression : HEAVY (Value:10)</input_parameters>
...
8.Device_Settings_Agent will return SUCCESS or FAILURE based on the result from the above step(7th). </automation_approch>
    <except_output>
...
TestMgr_DS_managerDeinitialize</test_stub_interface>
    <test_script>DS_SetCompression_HEAVY_FORMAT_reboot_persist_65</test_script>
    <skipped>No</skipped>
