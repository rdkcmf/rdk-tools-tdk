...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_DS_140</test_case_id>
    <test_objective>Device Setting –  This test gets the stereo mode value of SPDIF before and after reboot</test_objective>
...
6.Device_Settings_Agent will check the current stereo format with new stereo format and expect the value to be SURROUND.
...
TestMgr_DS_managerDeinitialize</test_stub_interface>
    <test_script>DS_getSPDIF_SURROUND_Persistent_AfterReboot_140</test_script>
    <skipped>No</skipped>
