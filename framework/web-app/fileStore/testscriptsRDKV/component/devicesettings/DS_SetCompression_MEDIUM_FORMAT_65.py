...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>615</id>
  <version>2</version>
  <name>DS_SetCompression_MEDIUM_FORMAT_65</name>
  <primitive_test_id>78</primitive_test_id>
  <primitive_test_name>DS_SetCompression</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>This test script Sets and gets the MEDIUM Compression Format of Audio Test Case ID : CT_DS_65.Note:This script will return duplicates, If running second time without restarting agent. Agent process may lead to crash/restart.This is an issue with DS.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    ...
    <test_objective>Device Setting –  Get and set  compression format to MEDIUM</test_objective>
...
TestMgr_DS_managerDeinitialize</test_stub_interface>
    <test_script>DS_SetCompression_MEDIUM_FORMAT_65</test_script>
    <skipped>No</skipped>
