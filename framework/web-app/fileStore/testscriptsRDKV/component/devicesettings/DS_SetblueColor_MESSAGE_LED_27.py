...
Test Case ID : CT_DS_27</synopsis>
  ...
  <test_cases>
    ...
    <test_objective>Device Setting – Get and Set the color of the MESSAGE LED to BLUE color.</test_objective>
...
6. TM makes RPC calls for getting the color of MESSAGE Indicator from Device Settings_stub and verify whether the color has changed.
