...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>603</id>
  <version>2</version>
  <name>DS_SetAudioLevel_value in range_test_53</name>
  <primitive_test_id>110</primitive_test_id>
  <primitive_test_name>DS_SetAudioLevel</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>This script will check for setting and getting the in range value for audio level
TestCase ID:53</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_DS_53</test_case_id>
    <test_objective>Device Setting – Get and Set the audio level with valid value.</test_objective>
...
TestMgr_DS_managerDeinitialize</test_stub_interface>
    <test_script>DS_SetAudioLevel_value in range_test_53</test_script>
    <skipped>No</skipped>
