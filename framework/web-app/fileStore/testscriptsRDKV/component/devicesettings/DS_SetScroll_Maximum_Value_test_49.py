...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>599</id>
  <version>1</version>
  <name>DS_SetScroll_Maximum_Value_test_49</name>
  <primitive_test_id>84</primitive_test_id>
  <primitive_test_name>DS_SetScroll</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>ALLOCATED</status>
  <synopsis>This test script Sets and gets the maximum value for scroll information of given Front panel Indicator
Test Case ID : CT_DS_49</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_DS_49</test_case_id>
    <test_objective>Device Setting –  Get and Set the  information for scroll with maximum Viteration,Hiteration &amp; hold_duration.</test_objective>
...
TestMgr_DS_managerDeinitialize
    ...
    <test_script>DS_SetScroll_Maximum_Value_test_49</test_script>
    <skipped>No</skipped>
