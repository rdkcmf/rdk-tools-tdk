...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <status>FREE</status>
  <synopsis>This test script Sets and gets the Invalid Color for the Front panel Indicator(Negative Scenario)
Test Case ID : CT_DS_37. NOTE: This test script cause the DS agent crash.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    ...
    <test_objective>Device Setting – Get and Set the color of the POWER LED to INVALID color.</test_objective>
