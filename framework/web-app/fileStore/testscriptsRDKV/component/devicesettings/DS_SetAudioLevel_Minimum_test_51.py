...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>601</id>
  <version>1</version>
  <name>DS_SetAudioLevel_Minimum_test_51</name>
  <primitive_test_id>110</primitive_test_id>
  <primitive_test_name>DS_SetAudioLevel</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>ALLOCATED</status>
  <synopsis>This script will check for setting and getting the minimum value for audio level
TestCase ID:51</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_DS_51</test_case_id>
    <test_objective>Device Setting – Get and Set the minimum audio level.</test_objective>
...
Eg: value is 0.5</input_parameters>
...
TestMgr_DS_managerDeinitialize</test_stub_interface>
    <test_script>DS_SetAudioLevel_Minimum_test_51</test_script>
    <skipped>No</skipped>
