...
<xml>
  ...
  <name>ACM_GetAudioProperties</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To retrieve current audio properties for ACM</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>CT_ACM_04</test_case_id>
    <test_objective>To retrieve current audio properties for ACM</test_objective>
...
3. AudioCaptureMgr agent will invoke the IARM_Bus_Call for IARMBUS_AUDIOCAPTUREMGR_GET__AUDIO_PROPS
4. Check if the IARMBUS call is success and the audio properties returned is non empty and return SUCCESS/FAILURE
...
Checkpoint 2.Verify the value returned for audio properties is not empty</except_output>
    <priority>High</priority>
    <test_stub_interface>libaudiocapturemgrstub.so</test_stub_interface>
    <test_script>ACM_GetAudioProperties</test_script>
    <skipped>No</skipped>
...
iarmObj.configureTestCase(ip,port,'ACM_GetAudioProperties');
...
if "SUCCESS" in iarmLoadStatus.upper():
        ...
        if "SUCCESS" in result:
                ...
                if "SUCCESS" in result:
                        ...
                        acmObj.configureTestCase(ip,port,'ACM_GetAudioProperties');
					...
					if sessionId == -1:
						...
						#Prmitive test case which associated to this Script
							...
							if (properties['DelayComp'] != "" or properties['Threshold'] != "" or propertiess['FifoSize'] != ""):
								...
								tdkTestObj.setResultStatus("FAILURE");
								print "Retrieved Audio Properties not correct";
						else:
                                                	tdkTestObj.setResultStatus("FAILURE");
