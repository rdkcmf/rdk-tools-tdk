...
<xml>
  ...
  <name>ACM_GetOutputProperties</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To retrieve output properties for ACM</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>CT_ACM_06</test_case_id>
    <test_objective>To retrieve output properties for ACM</test_objective>
...
Checkpoint 2.Verify the value returned for output properties is not empty</except_output>
    <priority>High</priority>
    <test_stub_interface>libaudiocapturemgrstub.so</test_stub_interface>
    <test_script>ACM_GetOutputProperties</test_script>
    <skipped>No</skipped>
...
iarmObj.configureTestCase(ip,port,'ACM_GetOutputProperties');
...
if "SUCCESS" in iarmLoadStatus.upper():
        ...
        if "SUCCESS" in result:
                ...
                if "SUCCESS" in result:
                        ...
                        acmObj.configureTestCase(ip,port,'ACM_GetOutputProperties');
						...
						#Prmitive test case which associated to this Script
							...
							if properties != "":
                                		        	tdkTestObj.setResultStatus("SUCCESS");
                                                		...
                                                		tdkTestObj.setResultStatus("FAILURE");
			                                        print "Output properties retrieved is empty";
						else:
                                                	tdkTestObj.setResultStatus("FAILURE");
