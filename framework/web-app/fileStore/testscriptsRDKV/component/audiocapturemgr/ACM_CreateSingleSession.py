...
<xml>
  ...
  <name>ACM_CreateSingleSession</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To check if creation of ACM session is success</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>CT_ACM_01</test_case_id>
    <test_objective>To check if creation of ACM session is success</test_objective>
...
3. TM will check if the IARMBUS call is success and return SUCCESS/FAILURE status based on that.</automation_approch>
    <except_output>Checkpoint 1.Verify the IARMBUS call is SUCCESS</except_output>
    <priority>High</priority>
    <test_stub_interface>libaudiocapturemgrstub.so</test_stub_interface>
    <test_script>ACM_CreateSingleSession</test_script>
    <skipped>No</skipped>
...
iarmObj.configureTestCase(ip,port,'ACM_CreateSingleSession');
...
if "SUCCESS" in iarmLoadStatus.upper():
        ...
        if "SUCCESS" in result:
                ...
                if "SUCCESS" in result:
                        ...
                        acmObj.configureTestCase(ip,port,'ACM_CreateSingleSession');
