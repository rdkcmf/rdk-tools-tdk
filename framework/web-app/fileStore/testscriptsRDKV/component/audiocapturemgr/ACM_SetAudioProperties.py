...
<xml>
  ...
  <name>ACM_SetAudioProperties</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To set audio properties for ACM</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>CT_ACM_08</test_case_id>
    <test_objective>To set audio properties for ACM</test_objective>
...
6. Check if the audio properties returned are same as the properties set in step 4 and return SUCCESS/FAILURE
...
Checkpoint 2.Verify the value returned for output properties are same the values set</except_output>
    <priority>High</priority>
    <test_stub_interface>libaudiocapturemgrstub.so</test_stub_interface>
    <test_script>ACM_SetAudioProperties</test_script>
    <skipped>No</skipped>
...
iarmObj.configureTestCase(ip,port,'ACM_SetAudioProperties');
...
if "SUCCESS" in iarmLoadStatus.upper():
        ...
        if "SUCCESS" in result:
                ...
                if "SUCCESS" in result:
                        ...
                        acmObj.configureTestCase(ip,port,'ACM_SetAudioProperties');
