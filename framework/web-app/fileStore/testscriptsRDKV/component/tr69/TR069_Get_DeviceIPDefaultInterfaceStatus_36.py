...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1372</id>
  <version>6</version>
  <name>TR069_Get_DeviceIPDefaultInterfaceStatus_36</name>
  ...
  <status>FREE</status>
  <synopsis>Objective: To fetch the IP interface Status by querying tr69Hostif through curl.  Query string "Device.IP.Interface.1.Status". No set operation avaliable for this parameter. 
TestCaseID: CT_TR69_36
TestType: Positive</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_TR69_36</test_case_id>
    <test_objective>To fetch the IP interface Status by querying tr69Hostif through curl. 
Query string "Device.IP.Interface.1.Status".
Assumption every device will have the loopback interface.
No set operation avaliable for this parameter.</test_objective>
    <test_type>Positive</test_type>
    <test_setup>XI3</test_setup>
    <pre_requisite>No</pre_requisite>
    <api_or_interface_used>curl -d '{"paramList" : [{"name" : "Device.IP.Interface.1.Status"}]}' http://127.0.0.1:10999</api_or_interface_used>
...
"Device.IP.Interface.1.Status." to fetch the IP interface Status.
3. Tr69Test agent will get the curl response which be a string “Up”,”Down”,”Unknown”,”Dormant”,”NotPresent”,”LowerLayerDown”,or “Error” on SUCCESS.
4. If tr69Test agent will get the empty curl response if FAILURE.
5. TM Unloads tr69Test agent.</automation_approch>
    <except_output>Checkpoint 1. Need to get valid string “Up”,”Down”,”Unknown”,”Dormant”,”NotPresent”,”LowerLayerDown”,or “Error” on SUCCESS. Empty on FAILURE.</except_output>
    <priority>High</priority>
    <test_stub_interface>libtr69stub.so</test_stub_interface>
    <test_script>TR069_Get_DeviceIPDefaultInterfaceStatus_36</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TR069_Get_DeviceIPDefaultInterfaceStatus_36');
...
profilePath = "Device.IP.Interface.1.Status"
