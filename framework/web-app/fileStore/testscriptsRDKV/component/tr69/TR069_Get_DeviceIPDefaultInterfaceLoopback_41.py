...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1420</id>
  <version>3</version>
  <name>TR069_Get_DeviceIPDefaultInterfaceLoopback_41</name>
  ...
  <status>FREE</status>
  <synopsis>Objective: To fetch the IP Interface Loopback by querying tr69Hostif through curl.  Query string "Device.IP.Interface.1.Loopback". Assumption every device will have the loopback interface.   
TestCaseID: CT_TR69_41
TestType: Positive</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_TR69_41</test_case_id>
    <test_objective>To fetch the IP Interface Loopback by querying tr69Hostif through curl. 
Query string "Device.IP.Interface.1.Loopback".
Assumption every device will have the loopback interface.</test_objective>
    ...
    <api_or_interface_used>curl -d '{"paramList" : [{"name" : "Device.IP.Interface.1.Loopback"}]}' http://127.0.0.1:10999</api_or_interface_used>
...
"Device.IP.Interface.1.Loopback." to get the IP Interface loopback.
...
5. TM Unloads tr69Test agent.</automation_approch>
    ...
    <test_script>TR069_Get_DeviceIPDefaultInterfaceLoopback_41</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TR069_Get_DeviceIPDefaultInterfaceLoopback_41');
...
profilePath = "Device.IP.Interface.1.Loopback"
