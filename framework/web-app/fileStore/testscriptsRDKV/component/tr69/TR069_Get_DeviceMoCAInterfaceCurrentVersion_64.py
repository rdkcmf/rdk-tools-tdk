...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1538</id>
  <version>2</version>
  <name>TR069_Get_DeviceMoCAInterfaceCurrentVersion_64</name>
  ...
  <status>FREE</status>
  <synopsis>Objective : To fetch the MoCA version that the MoCA network is currently running by querying tr69Hostif through curl. Query string "Device.MoCA.Interafce.1.CurrentVersion".
Test Case ID: CT_TR69_64
Test Case Type: Positive.</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_TR69_64</test_case_id>
    <test_objective>To fetch the MoCA version that the MoCA network is currently running by querying tr69Hostif through curl. 
Query string "Device.MoCA.Interafce.1.CurrentVersion".
No set operation avaliable for this parameter.</test_objective>
    <test_type>Positive</test_type>
    <test_setup>XI3</test_setup>
    <pre_requisite>No</pre_requisite>
    <api_or_interface_used>curl -d '{"paramList" : [{"name" : "Device.MoCA.Interface.1.CurrentVersion"}]}' http://127.0.0.1:10999</api_or_interface_used>
...
"Device.MoCA.Interface.1.HighestVersion" to fetch the MoCA version that the MoCA network is currently running.
...
5. TM Unloads tr69Test agent.</automation_approch>
    ...
    <test_script>TR069_Get_DeviceMoCAInterfaceCurrentVersion_64</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TR069_Get_DeviceMoCAInterfaceCurrentVersion_64');
...
profilePath = "Device.MoCA.Interface.1.CurrentVersion"
