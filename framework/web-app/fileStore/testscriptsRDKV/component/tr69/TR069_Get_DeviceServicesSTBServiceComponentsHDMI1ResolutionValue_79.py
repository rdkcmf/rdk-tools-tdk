...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1555</id>
  <version>3</version>
  <name>TR069_Get_DeviceServicesSTBServiceComponentsHDMI1ResolutionValue_79</name>
  ...
  <status>FREE</status>
  <synopsis>Objective : To fetch the current resolution of the HDMI output by querying tr69Hostif through curl. Query string Device.Services.STBService.1.Components.HDMI.1.ResolutionValue".
Test Case ID: TC_TR69_79.
Test Case Type: Positive.</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_TR69_79</test_case_id>
    <test_objective>To fetch the current resolution of the HDMI output by querying tr69Hostif through curl. 
Query string "Device.Services.STBService.1.Components.HDMI.1.ResolutionValue".
But When ResolutionMode is “Auto” it as no effect.</test_objective>
    <test_type>Positive</test_type>
    <test_setup>XI3</test_setup>
    <pre_requisite>HDMI Cable as to be connected  from XI3 STB to TV.</pre_requisite>
    <api_or_interface_used>curl -d '{"paramList" : [{"name" : "Device.Services.STBService.1.Components.HDMI.1.ResolutionValue”}]}' http://127.0.0.1:10999</api_or_interface_used>
...
"Device.Services.STBService.1.Components.HDMI.1.ResolutionValue" to fetch the current resolution of the HDMI output.
3. Tr69Test agent will get the curl response which be a valid string value on SUCCESS.
...
5. TM Unloads tr69Test agent.</automation_approch>
    ...
    <test_script>TR069_Get_DeviceServicesSTBServiceComponentsHDMI1ResolutionValue_79</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TR069_Get_DeviceServicesSTBServiceComponentsHDMI1ResolutionValue_79');
...
profilePath = "Device.Services.STBService.1.Components.HDMI.1.ResolutionValue"
