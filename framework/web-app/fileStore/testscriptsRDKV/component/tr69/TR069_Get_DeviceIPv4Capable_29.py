...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1341</id>
  <version>2</version>
  <name>TR069_Get_DeviceIPv4Capable_29</name>
  ...
  <status>FREE</status>
  <synopsis>Objective: To fetch whether or not the device is IPv4 capable by querying tr69Hostif through curl.  Query string "Device.IP.IPv4Capable". No set operation avaliable for this parameter. 
TestCaseID: CT_TR69_29
TestType: Positive</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_TR69_29</test_case_id>
    <test_objective>To fetch whether or not the device is IPv4 capable by querying tr69Hostif through curl. 
Query string "Device.IP.IPv4Capable".
No set operation avaliable for this parameter.</test_objective>
    <test_type>Positive</test_type>
    <test_setup>XI3</test_setup>
    <pre_requisite>No</pre_requisite>
    <api_or_interface_used>curl -d '{"paramList" : [{"name" : "Device.IP.IPv4Capable"}]}' http://127.0.0.1:10999</api_or_interface_used>
...
"Device.IP.IPv4Capable." to fetch whether or not the device is IPv4 capable.
3. Tr69Test agent will get the curl response which be a vaild string “true” or “false” on SUCCESS.
...
5. TM Unloads tr69Test agent.</automation_approch>
    ...
    <test_script>TR069_Get_DeviceIPv4Capable_29</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TR069_Get_DeviceIPv4Capable_29');
...
profilePath = "Device.IP.IPv4Capable"
