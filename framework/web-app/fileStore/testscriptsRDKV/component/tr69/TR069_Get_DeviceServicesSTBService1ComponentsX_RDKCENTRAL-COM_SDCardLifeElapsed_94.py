...
<xml>
  ...
  <name>TR069_Get_DeviceServicesSTBService1ComponentsX_RDKCENTRAL-COM_SDCardLifeElapsed_94</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>This test is executed to get the value for "Device.Services.STBService.1.Components.X_RDKCENTRAL-COM_SDCard.LifeElapsed"</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>CT_TR69_94</test_case_id>
    <test_objective>To fetch the SD Card life elapsed value between 0 to 100 (increment in 10% or lower increments depending on Card+Host capabilities) by querying the tr69Hostif through curl.
Query string "Device.Services.STBService.1.Components.X_RDKCENTRAL-COM_SDCard.LifeElapsed".
No set operation available for this parameter.</test_objective>
    <test_type>Positive</test_type>
    <test_setup>XI3</test_setup>
    <pre_requisite>No</pre_requisite>
    <api_or_interface_used>curl -d '{"paramList" : [{"name" : "Device.Services.STBService.1.Components.X_RDKCENTRAL-COM_SDCard.LifeElapsed"}]}' http://127.0.0.1:10999</api_or_interface_used>
...
"Device.Services.STBService.1.Components.X_RDKCENTRAL-COM_SDCard.LifeElapsed" to fetch the IP Address of the interface.
...
Checkpoint 2. Can verify returned IP address is correct or not through ifconifg cmd.</except_output>
    ...
    <test_script>TR069_Get_DeviceServicesSTBService1ComponentsX_RDKCENTRAL-COM_SDCardLifeElapsed_94</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TR069_Get_DeviceServicesSTBService1ComponentsX_RDKCENTRAL-COM_SDCardLifeElapsed_94');
...
profilePath = "Device.Services.STBService.1.Components.X_RDKCENTRAL-COM_SDCard.LifeElapsed"
