...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1358</id>
  <version>2</version>
  <name>TR069_Get_DeviceIPInterfaceNumOfEntries_32</name>
  ...
  <status>FREE</status>
  <synopsis>Objective: To fetch the number of entries in the Interface table by querying tr69Hostif through curl.  Query string "Device.IP.InterfaceNumberOfEntries". No set operation avaliable for this parameter.  
TestCaseID: CT_TR69_32
TestType: Positive</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_TR69_32</test_case_id>
    <test_objective>To fetch the number of entries in the Interface table by querying tr69Hostif through curl. 
Query string "Device.IP.InterfaceNumberOfEntries".
No set operation avaliable for this parameter.</test_objective>
    <test_type>Positive</test_type>
    <test_setup>XI3</test_setup>
    <pre_requisite>No</pre_requisite>
    <api_or_interface_used>curl -d '{"paramList" : [{"name" : "Device.IP.InterfaceNumberOfEntries"}]}' http://127.0.0.1:10999</api_or_interface_used>
...
"Device.IP.InterfaceNumberOfEntries." to fetch  the number of entries in the Interface table.
...
Checkpoint 2: We can use ifconfig to verify correctness of value.</except_output>
    <priority>High</priority>
    <test_stub_interface>libtr69stub.so</test_stub_interface>
    <test_script>TR069_Get_DeviceIPInterfaceNumOfEntries_32</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TR069_Get_DeviceIPInterfaceNumOfEntries_32');
...
profilePath = "Device.IP.InterfaceNumberOfEntries"
