...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1536</id>
  <version>2</version>
  <name>TR069_Get_DeviceMoCAInterfaceMaxEgressBW_62</name>
  ...
  <status>FREE</status>
  <synopsis>Objective : To fetch the maximum bandwidth of this interface for flows from the MoCA network by querying tr69Hostif through curl. Query string "Device.MoCA.Interafce.1.MaxEgressBW".
Test CaseID: CT_TR69_62
Test Case Type: Positive</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_TR69_62</test_case_id>
    <test_objective>To fetch the maximum bandwidth of this interface for flows from the MoCA network by querying tr69Hostif through curl. 
Query string "Device.MoCA.Interafce.1.MaxEgressBW".
No set operation avaliable for this parameter.</test_objective>
    <test_type>Positive</test_type>
    <test_setup>XI3</test_setup>
    <pre_requisite>No</pre_requisite>
    <api_or_interface_used>curl -d '{"paramList" : [{"name" : "Device.MoCA.Interface.1.MaxEgressBW"}]}' http://127.0.0.1:10999</api_or_interface_used>
...
"Device.MoCA.Interface.1.MaxIngressBW" to fetch the maximum bandwidth of this interface for flows from the MoCA network.
...
5. TM Unloads tr69Test agent.</automation_approch>
    ...
    <test_script>TR069_Get_DeviceMoCAInterfaceMaxEgressBW_62</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TR069_Get_DeviceMoCAInterfaceMaxEgressBW_62');
...
profilePath = "Device.MoCA.Interface.1.MaxEgressBW"
