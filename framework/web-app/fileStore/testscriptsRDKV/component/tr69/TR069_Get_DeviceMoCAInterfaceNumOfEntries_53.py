...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1503</id>
  <version>2</version>
  <name>TR069_Get_DeviceMoCAInterfaceNumOfEntries_53</name>
  ...
  <status>FREE</status>
  <synopsis>Objective: To fetch number of moca interface supported by querying tr69Hostif through curl.  Query string "Device.MoCA.InterfaceNumberOfEntries". No set operation avaliable for this parameter. 
Test Case ID: CT_TR69_53.
Test Type: Positive.</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_TR69_53</test_case_id>
    <test_objective>To fetch number of moca interface supported by querying tr69Hostif through curl. 
Query string "Device.MoCA.InterfaceNumberOfEntries".
No set operation avaliable for this parameter.</test_objective>
    <test_type>Positive</test_type>
    <test_setup>XI3</test_setup>
    <pre_requisite>No</pre_requisite>
    <api_or_interface_used>curl -d '{"paramList" : [{"name" : "Device.MoCA.InterfaceNumberOfEntries"}]}' http://127.0.0.1:10999</api_or_interface_used>
...
"Device.MoCA.InterfaceNumberOfEntries." to fetch number of moca interfaces supported.
3. Tr69Test agent will get the curl response which be a vaild unsigned integer number on SUCCESS.
...
5. TM Unloads tr69Test agent.</automation_approch>
    ...
    <test_script>TR069_Get_DeviceMoCAInterfaceNumOfEntries_53</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TR069_Get_DeviceMoCAInterfaceNumOfEntries_53');
...
profilePath = "Device.MoCA.InterfaceNumberOfEntries"
