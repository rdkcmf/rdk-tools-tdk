...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1377</id>
  <version>2</version>
  <name>TR069_Get_DeviceIPDefaultInterfaceName_37</name>
  ...
  <status>FREE</status>
  <synopsis>Objective: To fetch the IP interface name by querying tr69Hostif through curl.  Query string "Device.IP.Interface.1.Name".  No set operation avaliable for this parameter. 
TestCaseID: CT_TR69_37
TestType: Positive</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_TR69_37</test_case_id>
    <test_objective>To fetch the IP interface name by querying tr69Hostif through curl. 
Query string "Device.IP.Interface.1.Name".
...
No set operation avaliable for this parameter.</test_objective>
    ...
    <api_or_interface_used>curl -d '{"paramList" : [{"name" : "Device.IP.Interface.1.Name"}]}' http://127.0.0.1:10999</api_or_interface_used>
...
"Device.IP.Interface.1.Name." to fetch the IP interface Name.
...
5. TM Unloads tr69Test agent.</automation_approch>
    ...
    <test_script>TR069_Get_DeviceIPDefaultInterfaceName_37</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TR069_Get_DeviceIPDefaultInterfaceName_37');
...
profilePath = "Device.IP.Interface.1.Name"
