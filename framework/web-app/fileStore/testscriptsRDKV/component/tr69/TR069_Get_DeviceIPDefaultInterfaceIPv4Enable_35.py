...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <status>FREE</status>
  <synopsis>Objective: To fetch the status of the IPv4 stack attachment for an IP interface by querying tr69Hostif through curl.  Query string "Device.IP.Interface.1.IPv4Enable". 
TestCaseID: CT_TR69_35
TestType: Positive</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_TR69_35</test_case_id>
    <test_objective>To fetch the status of the IPv4 stack attachment for an IP interface by querying tr69Hostif through curl. 
Query string "Device.IP.Interface.1.IPv4Enable".
Assumption every device will have the loopback interface.</test_objective>
    ...
    <api_or_interface_used>curl -d '{"paramList" : [{"name" : "Device.IP.Interface.1.IPv4Enable"}]}' http://127.0.0.1:10999</api_or_interface_used>
...
"Device.IP.Interface.1.IPv4Enable." to fetch the status of the IPv4 stack attachment for an IP interface.
...
5. TM Unloads tr69Test agent.</automation_approch>
    ...
    <test_script>TR069_Get_DeviceIPDefaultInterfaceIPv4Enable_35</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TR069_Get_DeviceIPDefaultInterfaceIPv4Enable_35');
