...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1509</id>
  <version>3</version>
  <name>TR069_Get_DeviceMoCAInterfaceEnable_54</name>
  ...
  <status>FREE</status>
  <synopsis>Objective: To check whether moca interface is enabled or not by querying tr69Hostif through curl. 
Query string "Device.MoCA.Interface.1.Enabe". 
Test CaseID: CT_TR69_54
Test Case Type: Positive</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_TR69_54</test_case_id>
    <test_objective>To check whether moca interface is enabled or not by querying tr69Hostif through curl. 
Query string "Device.MoCA.Interface.1.Enabe".</test_objective>
    <test_type>Positive</test_type>
    <test_setup>XI3</test_setup>
    <pre_requisite>No</pre_requisite>
    <api_or_interface_used>curl -d '{"paramList" : [{"name" : "Device.MoCA.Interface.1.Enabe"}]}' http://127.0.0.1:10999</api_or_interface_used>
...
"Device.MoCA.Interface.1.Enabe" to check whether moca interfaces is enabled or not.
...
5. TM Unloads tr69Test agent.</automation_approch>
    ...
    <test_script>TR069_Get_DeviceMoCAInterfaceEnable_54</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TR069_Get_DeviceMoCAInterfaceEnable_54');
...
profilePath = "Device.MoCA.Interface.1.Enable"
