...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1563</id>
  <version>2</version>
  <name>TR069_Get_DeviceServicesSTBServiceComponentsVideoDecoder1Name_84</name>
  ...
  <status>FREE</status>
  <synopsis>objective : To fetch Human-readable name associated with this video decoder by querying tr69Hostif through curl. Query string "Device.Services.STBService.1.Components.VideoDecoder.1.Name".	
Test Case ID: TC_TR69_84.
Test Case Type: Positive.</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_TR69_84</test_case_id>
    <test_objective>To fetch Human-readable name associated with this video decoder by querying tr69Hostif through curl. 
Query string "Device.Services.STBService.1.Components.VideoDecoder.1.Name".
No set operation avaliable for this parameter.</test_objective>
    <test_type>Positive</test_type>
    <test_setup>XI3</test_setup>
    <pre_requisite/>
    <api_or_interface_used>curl -d '{"paramList" : [{"name" : "Device.Services.STBService.1.Components.VideoDecoder.1.Name”}]}' http://127.0.0.1:10999</api_or_interface_used>
...
"Device.Services.STBService.1.Components.VideoDecoder.1.Name" to fetch Human-readable name associated with this video decoder.
...
5. TM Unloads tr69Test agent.</automation_approch>
    ...
    <test_script>TR069_Get_DeviceServicesSTBServiceComponentsVideoDecoder1Name_84</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TR069_Get_DeviceServicesSTBServiceComponentsVideoDecoder1Name_84');
...
profilePath = "Device.Services.STBService.1.Components.VideoDecoder.1.Name"
