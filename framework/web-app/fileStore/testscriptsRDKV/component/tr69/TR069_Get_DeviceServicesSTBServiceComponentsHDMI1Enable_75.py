...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1551</id>
  <version>2</version>
  <name>TR069_Get_DeviceServicesSTBServiceComponentsHDMI1Enable_75</name>
  ...
  <status>FREE</status>
  <synopsis>Objective : To check whether HDMI output is enabled or disabled by querying tr69Hostif through curl. Query string "Device.Services.STBService.1.Components.HDMI.1.Enable".
Test Case ID: TC_TR69_75.
Test Case Type: Positive.</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_TR69_75</test_case_id>
    <test_objective>To check whether HDMI output is enabled or disabled by querying tr69Hostif through curl. 
Query string "Device.Services.STBService.1.Components.HDMI.1.Enable".</test_objective>
    <test_type>Positive</test_type>
    <test_setup>XI3</test_setup>
    <pre_requisite>HDMI Cable as to be connected  from XI3 STB to TV.</pre_requisite>
    <api_or_interface_used>curl -d '{"paramList" : [{"name" : "Device.Services.STBService.1.Components.HDMI.1.Enable”}]}' http://127.0.0.1:10999</api_or_interface_used>
...
"Device.Services.STBService.1.Components.HDMI.1.Enable" to check whether HDMI output is enabled or disabled.
3. Tr69Test agent will get the curl response which be a valid boolean value “true/false” on SUCCESS.
4. If tr69Test agent will get the empty curl response if FAILURE.
5. TM Unloads tr69Test agent.</automation_approch>
    <except_output>Checkpoint 1. Need to get boolean value “true/false” on SUCCESS. Empty on FAILURE.</except_output>
    <priority>High</priority>
    <test_stub_interface>libtr69stub.so</test_stub_interface>
    <test_script>TR069_Get_DeviceServicesSTBServiceComponentsHDMI1Enable_75</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TR069_Get_DeviceServicesSTBServiceComponentsHDMI1Enable_75');
...
profilePath = "Device.Services.STBService.1.Components.HDMI.1.Enable"
