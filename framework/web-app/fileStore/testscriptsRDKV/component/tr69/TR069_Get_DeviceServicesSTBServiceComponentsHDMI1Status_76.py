...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1552</id>
  <version>3</version>
  <name>TR069_Get_DeviceServicesSTBServiceComponentsHDMI1Status_76</name>
  ...
  <status>FREE</status>
  <synopsis>Objective : To fetch number of entries in the HDMI table by querying tr69Hostif through curl. 
Query string "Device.Services.STBService.1.Components.HDMI.1.Status".
Test Case ID: TC_TR69_76.
Test Case Type: Positive.</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_TR69_76</test_case_id>
    <test_objective>To fetch number of entries in the HDMI table by querying tr69Hostif through curl. 
Query string "Device.Services.STBService.1.Components.HDMI.1.Status".
No set operation avaliable for this parameter.</test_objective>
    ...
    <api_or_interface_used>curl -d '{"paramList" : [{"name" : "Device.Services.STBService.1.Components.HDMI.1.Status”}]}' http://127.0.0.1:10999</api_or_interface_used>
...
"Device.Services.STBService.1.Components.HDMI.1.Status" tocheck the status of HDMI output.
3. Tr69Test agent will get the curl response which be a valid string value “Disabled”,”Enabled” or “Error” on SUCCESS.
...
5. TM Unloads tr69Test agent.</automation_approch>
    ...
    <test_script>TR069_Get_DeviceServicesSTBServiceComponentsHDMI1Status_76</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TR069_Get_DeviceServicesSTBServiceComponentsHDMI1Status_76');
...
profilePath = "Device.Services.STBService.1.Components.HDMI.1.Status"
...
if 0 == len(details):
        ...
        expectedOutput = ["Disabled","Enabled","Error"]
