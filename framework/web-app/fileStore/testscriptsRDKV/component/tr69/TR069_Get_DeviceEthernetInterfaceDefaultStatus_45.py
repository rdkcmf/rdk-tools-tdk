...
TestType: Positive</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_TR69_45</test_case_id>
    <test_objective>To fetch the Ethernet interface Status by querying tr69Hostif through curl. 
Query string "Device.Ethernet.Interface.1.Status".
...
No set operation avaliable for this parameter.</test_objective>
    ...
    <api_or_interface_used>curl -d '{"paramList" : [{"name" : "Device.Ethernet.Interface.1.Status"}]}' http://127.0.0.1:10999</api_or_interface_used>
...
"Device.Ethernet.Interface.1.Status." to fetch the Ethernet interface Status.
...
5. TM Unloads tr69Test agent.</automation_approch>
    ...
    <test_script>TR069_Get_DeviceEthernetInterfaceDefaultStatus_45</test_script>
    <skipped>No</skipped>
