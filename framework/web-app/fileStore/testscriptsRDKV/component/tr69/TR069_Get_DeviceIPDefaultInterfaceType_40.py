...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1419</id>
  <version>3</version>
  <name>TR069_Get_DeviceIPDefaultInterfaceType_40</name>
  ...
  <status>FREE</status>
  <synopsis>Objective: To fetch the IP Interface type by querying tr69Hostif through curl.  Query string "Device.IP.Interface.1.Type". No set operation avaliable for this parameter.  
TestCaseID: CT_TR69_40
TestType: Positive</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_TR69_40</test_case_id>
    <test_objective>To fetch the IP Interface type by querying tr69Hostif through curl. 
Query string "Device.IP.Interface.1.Type".
...
No set operation avaliable for this parameter.</test_objective>
    ...
    <api_or_interface_used>curl -d '{"paramList" : [{"name" : "Device.IP.Interface.1.Type"}]}' http://127.0.0.1:10999</api_or_interface_used>
...
"Device.IP.Interface.1.Type." to get the IP Interface type.
...
5. TM Unloads tr69Test agent.</automation_approch>
    <except_output>Checkpoint 1. Need to get valid string “Normal”,
“Loopback”,
“Tunnel”, or 
“Tunneled” on SUCCESS. Empty on FAILURE.</except_output>
    <priority>High</priority>
    <test_stub_interface>libtr69stub.so</test_stub_interface>
    <test_script>TR069_Get_DeviceIPDefaultInterfaceType_40</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TR069_Get_DeviceIPDefaultInterfaceType_40');
...
profilePath = "Device.IP.Interface.1.Type"
...
expectedOutput = ["Normal","Loopback","Tunnel","Tunneled"]
