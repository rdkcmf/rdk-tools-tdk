...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1510</id>
  <version>2</version>
  <name>TR069_Get_DeviceMoCAInterfaceStatus_55</name>
  ...
  <status>FREE</status>
  <synopsis>Objective: To check current operational state of moca interface  by querying tr69Hostif through curl. 
Query string "Device.MoCA.Interface.1.Status".
Test Case ID: CT_TR69_55
Test Case Type: Positive</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_TR69_55</test_case_id>
    <test_objective>To check current operational state of moca interface  by querying tr69Hostif through curl. 
Query string "Device.MoCA.Interface.1.Status".
No set operation avaliable for this parameter.</test_objective>
    <test_type>Positive</test_type>
    <test_setup>XI3</test_setup>
    <pre_requisite>No</pre_requisite>
    <api_or_interface_used>curl -d '{"paramList" : [{"name" : "Device.MoCA.Interface.1.Status"}]}' http://127.0.0.1:10999</api_or_interface_used>
...
"Device.MoCA.Interface.1.Status" to check current operational state of moca interfaces.
3. Tr69Test agent will get the curl response which be a valid string “Up”,”Down”,”Unknown”,”Dormant”,”NotPresent”,”LowerLayerDown”,”Error” on SUCCESS.
...
5. TM Unloads tr69Test agent.</automation_approch>
    ...
    <test_script>TR069_Get_DeviceMoCAInterfaceStatus_55</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TR069_Get_DeviceMoCAInterfaceStatus_55');
...
profilePath = "Device.MoCA.Interface.1.Status"
