...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1550</id>
  <version>2</version>
  <name>TR069_Get_DeviceServicesSTBServiceComponentsHDMINumberOfEntries_74</name>
...
Query string "Device.Services.STBService.1.Components.HDMINumberOfEntries".
Test Case ID: TC_TR69_74.
Test Case Type: Positive.</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_TR69_74</test_case_id>
...
No set operation avaliable for this parameter.</test_objective>
    ...
    <api_or_interface_used>curl -d '{"paramList" : [{"name" : "Device.Services.STBService.1.Components.HDMINumberOfEntries”}]}' http://127.0.0.1:10999</api_or_interface_used>
...
"Device.Services.STBServiceNumberOfEntries" to fetch number of entries in the HDMI Table.
...
5. TM Unloads tr69Test agent.</automation_approch>
    ...
    <test_script>TR069_Get_DeviceServicesSTBServiceComponentsHDMINumberOfEntries_74</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TR069_Get_DeviceServicesSTBServiceComponentsHDMINumberOfEntries_74');
...
profilePath = "Device.Services.STBService.1.Components.HDMINumberOfEntries"
