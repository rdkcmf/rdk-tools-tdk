...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1548</id>
  <version>4</version>
  <name>TR069_Get_DeviceMoCAInterfaceQoSFlowStats1FlowID_72</name>
...
Test Case Type: Positive.</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_TR69_72</test_case_id>
    <test_objective>To fetch flow ID used to identify a flow in the network by querying tr69Hostif through curl. 
Query string "Device.MoCA.Interface.1.QoS.FlowStats.1.FlowID".
No set operation avaliable for this parameter.</test_objective>
    <test_type>Positive</test_type>
    <test_setup>XI3</test_setup>
    <pre_requisite>No</pre_requisite>
    <api_or_interface_used>curl -d '{"paramList" : [{"name" : "Device.MoCA.Interface.1.QoS.FlowStats.1.FlowID"}]}' http://127.0.0.1:10999</api_or_interface_used>
...
"Device.MoCA.Interface.1.QoS.FlowStats.1.FlowID" to fetch flow ID used to identify a flow in the network.
...
5. TM Unloads tr69Test agent.</automation_approch>
    ...
    <test_script>TR069_Get_DeviceMoCAInterfaceQoSFlowStats1FlowID_72</test_script>
    <skipped>Yes</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TR069_Get_DeviceMoCAInterfaceQoSFlowStats1FlowID_72');
...
profilePath = "Device.MoCA.Interface.1.QoS.FlowStats.1.FlowID"
