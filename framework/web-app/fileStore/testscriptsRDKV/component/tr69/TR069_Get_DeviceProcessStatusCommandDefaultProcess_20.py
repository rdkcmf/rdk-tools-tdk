...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1325</id>
  <version>2</version>
  <name>TR069_Get_DeviceProcessStatusCommandDefaultProcess_20</name>
  ...
  <test_cases>
    <test_case_id>CT_TR69_20</test_case_id>
    <test_objective>To fetch the command name of the process running by querying  the tr69Hostif through curl. 
Query string "Device.DeviceInfo.ProcessStatus.Process.1.Command".
...
Assumption atleast one process will be running in the system.</test_objective>
    ...
    <api_or_interface_used>curl -d '{"paramList" : [{"name" : "Device.DeviceInfo.ProcessStatus.Process.1.Command"}]}' http://127.0.0.1:10999</api_or_interface_used>
...
"Device.DeviceInfo.ProcessStatus.Process.1.Command" to fetch the command name of the process.
...
5. TM Unloads tr69Test agent.</automation_approch>
    ...
    <test_script>TR069_Get_DeviceProcessStatusCommandDefaultProcess_20</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TR069_Get_DeviceProcessStatusCommandDefaultProcess_20');
...
profilePath = "Device.DeviceInfo.ProcessStatus.Process.1.Command"
