...
Test Case Type: Positive.</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_TR69_69</test_case_id>
    <test_objective>To fetch Node ID of the associated remote device by querying tr69Hostif through curl. 
Query string "Device.MoCA.Interface.1.AssociatedDevice.1.NodeID".
No set operation avaliable for this parameter.</test_objective>
    <test_type>Positive</test_type>
    <test_setup>XI3</test_setup>
    <pre_requisite>No</pre_requisite>
    <api_or_interface_used>curl -d '{"paramList" : [{"name" : "Device.MoCA.Interface.1.AssociatedDevice.1.NodeID"}]}' http://127.0.0.1:10999</api_or_interface_used>
...
"Device.MoCA.Interface.1.AssociatedDevice.1.NodeID" to fetch Node ID of the associated remote device.
...
5. TM Unloads tr69Test agent.</automation_approch>
    ...
    <test_script>TR069_Get_DeviceMoCAInterfaceAssociatedDevice1NodeID_69</test_script>
    <skipped>No</skipped>
