...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1549</id>
  <version>2</version>
  <name>TR069_Get_DeviceServicesSTBServiceNumberOfEntries_73</name>
  ...
  <status>FREE</status>
  <synopsis>Objective : To fetch number of entries in the STBService table by querying tr69Hostif through curl. Query string "Device.Services.STBServiceNumberOfEntries".
Test Case ID: CT_TR69_73.
Test Case Type: Positive.</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_TR69_73</test_case_id>
    <test_objective>To fetch number of entries in the STBService table by querying tr69Hostif through curl. 
Query string "Device.Services.STBServiceNumberOfEntries".
No set operation avaliable for this parameter.</test_objective>
    <test_type>Positive</test_type>
    <test_setup>XI3</test_setup>
    <pre_requisite>No</pre_requisite>
    <api_or_interface_used>curl -d '{"paramList" : [{"name" : "Device.Services.STBServiceNumberOfEntries"}]}' http://127.0.0.1:10999</api_or_interface_used>
...
"Device.Services.STBServiceNumberOfEntries" to fetch number of entries in the STBService Table.
...
5. TM Unloads tr69Test agent.</automation_approch>
    ...
    <test_script>TR069_Get_DeviceServicesSTBServiceNumberOfEntries_73</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TR069_Get_DeviceServicesSTBServiceNumberOfEntries_73');
...
profilePath = "Device.Services.STBServiceNumberOfEntries"
