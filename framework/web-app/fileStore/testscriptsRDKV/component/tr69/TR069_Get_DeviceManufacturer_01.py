...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1297</id>
  <version>2</version>
  <name>TR069_Get_DeviceManufacturer_01</name>
  ...
  <status>FREE</status>
  <synopsis>Objective: To fetch the device manufacturer name by querying  the tr69Hostif through curl.  Query string "Device.DeviceInfo.Manufacturer". No set operation avaliable for this parameter.
TestCaseID: CT_TR69_01
TestType: Positive</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_TR69_01</test_case_id>
    <test_objective>To fetch the device manufacturer name by querying 
the tr69Hostif through curl. 
Query string "Device.DeviceInfo.Manufacturer".
No set operation avaliable for this parameter.</test_objective>
    <test_type>Positive</test_type>
    <test_setup>XI3</test_setup>
    <pre_requisite>No</pre_requisite>
    <api_or_interface_used>curl -d '{"paramList" : [{"name" : "Device.DeviceInfo.Manufacturer"}]}' http://127.0.0.1:10999</api_or_interface_used>
...
"Device.DeviceInfo.Manufacturer" to fetch the Device manufacturer name.
3. Tr69Test agent will get the curl response which be a vaild name 
On SUCCESS.
...
5. TM Unloads tr69Test agent.</automation_approch>
    ...
    <test_script>TR069_Get_DeviceManufacturer_01</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TR069_Get_DeviceManufacturer_01');
...
profilePath = "Device.DeviceInfo.Manufacturer"
