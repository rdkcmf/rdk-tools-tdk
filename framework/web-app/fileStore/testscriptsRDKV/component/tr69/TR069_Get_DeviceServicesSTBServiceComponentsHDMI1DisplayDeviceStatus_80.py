...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1556</id>
  <version>7</version>
  <name>TR069_Get_DeviceServicesSTBServiceComponentsHDMI1DisplayDeviceStatus_80</name>
  ...
  <status>FREE</status>
  <synopsis>Objective : To fetch the status of the connected HDMI Display device by querying tr69Hostif through curl. Query string "Device.Services.STBService.1.Components.HDMI.1.DisplayDevice.Status".
Test Case ID: TC_TR69_80.
Test Case Type: Positive.</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_TR69_80</test_case_id>
    <test_objective>To fetch the status of the connected HDMI Display device by querying tr69Hostif through curl. 
Query string "Device.Services.STBService.1.Components.HDMI.1.DisplayDevice.Status".
No set operation avaliable for this parameter.</test_objective>
    ...
    <api_or_interface_used>curl -d '{"paramList" : [{"name" : "Device.Services.STBService.1.Components.HDMI.1.DisplayDevice.Status”}]}' http://127.0.0.1:10999</api_or_interface_used>
...
"Device.Services.STBService.1.Components.HDMI.1.DisplayDevice.Status" to fetch the status of the connected HDMI Display device.
3. Tr69Test agent will get the curl response which be a valid string value “Present”,”None” or “Error” on SUCCESS.
...
5. TM Unloads tr69Test agent.</automation_approch>
    ...
    <test_script>TR069_Get_DeviceServicesSTBServiceComponentsHDMI1DisplayDeviceStatus_80</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TR069_Get_DeviceServicesSTBServiceComponentsHDMI1DisplayDeviceStatus_80');
...
profilePath = "Device.Services.STBService.1.Components.HDMI.1.DisplayDevice.Status"
