...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1299</id>
  <version>2</version>
  <name>TR069_Get_DeviceModelName_03</name>
  ...
  <status>FREE</status>
  <synopsis>Objective: To fetch the device ModelName by querying  the tr69Hostif through curl.  Query string "Device.DeviceInfo.ModelName". No set operation avaliable for this parameter.
TestCaseID: CT_TR69_03
TestType: Positive</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_TR69_03</test_case_id>
    <test_objective>To fetch the device ModelName by querying 
the tr69Hostif through curl. 
Query string "Device.DeviceInfo.ModelName".
No set operation avaliable for this parameter.</test_objective>
    <test_type>Positive</test_type>
    <test_setup>XI3</test_setup>
    <pre_requisite>No</pre_requisite>
    <api_or_interface_used>curl -d '{"paramList" : [{"name" : "Device.DeviceInfo.ModelName"}]}' http://127.0.0.1:10999</api_or_interface_used>
...
"Device.DeviceInfo.ModelName" to fetch the Device ModelName, which tells the model Name of CPE device.
...
5. TM Unloads tr69Test agent.</automation_approch>
    ...
    <test_script>TR069_Get_DeviceModelName_03</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TR069_Get_DeviceModelName_03');
...
profilePath = "Device.DeviceInfo.ModelName"
