...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1302</id>
  <version>2</version>
  <name>TR069_Get_DeviceSerialNumber_06</name>
  ...
  <status>FREE</status>
  <synopsis>Objective: To fetch the device serial number by querying  the tr69Hostif through curl.  Query string "Device.DeviceInfo.SerialNumber". No set operation avaliable for this parameter.
TestCaseID: CT_TR69_06
TestType: Positive</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_TR69_06</test_case_id>
    <test_objective>To fetch the device serial number by querying 
the tr69Hostif through curl. 
Query string "Device.DeviceInfo.SerialNumber".
No set operation avaliable for this parameter.</test_objective>
    <test_type>Positive</test_type>
    <test_setup>XI3</test_setup>
    <pre_requisite>No</pre_requisite>
    <api_or_interface_used>curl -d '{"paramList" : [{"name" : "Device.DeviceInfo.SerialNumber"}]}' http://127.0.0.1:10999</api_or_interface_used>
...
"Device.DeviceInfo.SerialNumber" to fetch the identifier of the particular device which is unique.
...
5. TM Unloads tr69Test agent.</automation_approch>
    ...
    <test_script>TR069_Get_DeviceSerialNumber_06</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TR069_Get_DeviceSerialNumber_06');
...
profilePath = "Device.DeviceInfo.SerialNumber"
