...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1427</id>
  <version>2</version>
  <name>TR069_Get_DeviceEthernetInterfaceDefaultMACAddress_48</name>
  ...
  <status>FREE</status>
  <synopsis>Objective: To fetch the MAC Address of at Ethernet Interface by querying tr69Hostif through curl.  Query string "Device.Ethernet.Interafce.1.MACAddress". No set operation avaliable for this parameter.   
TestCaseID: CT_TR69_48
TestType: Positive</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_TR69_48</test_case_id>
    <test_objective>To fetch the MAC Address of at Ethernet Interface by querying tr69Hostif through curl. 
Query string "Device.Ethernet.Interafce.1.MACAddress".
No set operation avaliable for this parameter.</test_objective>
    <test_type>Positive</test_type>
    <test_setup>XI3</test_setup>
    <pre_requisite>No</pre_requisite>
    <api_or_interface_used>curl -d '{"paramList" : [{"name" : "Device.Ethernet.Interface.1.MACAddress"}]}' http://127.0.0.1:10999</api_or_interface_used>
...
"Device.Ethernet.Interface.1.MACAddress." to fetch the MACAddress of the Ethernet Interface.
...
5. TM Unloads tr69Test agent.</automation_approch>
    ...
    <test_script>TR069_Get_DeviceEthernetInterfaceDefaultMACAddress_48</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TR069_Get_DeviceEthernetInterfaceDefaultMACAddress_48');
...
profilePath = "Device.Ethernet.Interface.1.MACAddress"
