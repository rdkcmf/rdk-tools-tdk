...
<xml>
  ...
  <name>TR069_Get_DeviceServicesSTBService1ComponentsX_RDKCENTRAL-COM_SDCardModel_97</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>This test is executed to get the value for 	"Device.Services.STBService.1.Components.X_RDKCENTRAL-COM_SDCard.Model"</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>CT_TR69_97</test_case_id>
    <test_objective>To fetch the Model of SD Flash card (5 character PNM field in CID register)	by querying the tr69Hostif through curl.
Query string "Device.Services.STBService.1.Components.X_RDKCENTRAL-COM_SDCard.Model".
No set operation available for this parameter.</test_objective>
    <test_type>Positive</test_type>
    <test_setup>XI3</test_setup>
    <pre_requisite>No</pre_requisite>
    <api_or_interface_used>curl -d '{"paramList" : [{"name" : "Device.Services.STBService.1.Components.X_RDKCENTRAL-COM_SDCard.Model"}]}' http://127.0.0.1:10999</api_or_interface_used>
...
"Device.Services.STBService.1.Components.X_RDKCENTRAL-COM_SDCard.Model" to fetch the IP Address of the interface.
...
Checkpoint 2. Can verify returned IP address is correct or not through ifconifg cmd.</except_output>
    ...
    <test_script>TR069_Get_DeviceServicesSTBService1ComponentsX_RDKCENTRAL-COM_SDCardModel_97</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TR069_Get_DeviceServicesSTBService1ComponentsX_RDKCENTRAL-COM_SDCardModel_97');
...
profilePath = "Device.Services.STBService.1.Components.X_RDKCENTRAL-COM_SDCard.Model"
