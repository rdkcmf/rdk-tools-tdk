...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1426</id>
  <version>3</version>
  <name>TR069_Get_DeviceEthernetInterfaceDefaultUpstream_47</name>
  ...
  <status>FREE</status>
  <synopsis>Objective: To fetch the Upstream device type for an Ethernet Interface by querying tr69Hostif through curl.  Query string "Device.Ethernet.Interafce.1.Upstream". No set operation avaliable for this parameter.   
TestCaseID: CT_TR69_47
TestType: Positive</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_TR69_47</test_case_id>
    <test_objective>To fetch the Upstream device type for an Ethernet Interface by querying tr69Hostif through curl. 
Query string "Device.Ethernet.Interafce.1.Upstream".
No set operation avaliable for this parameter.</test_objective>
    <test_type>Positive</test_type>
    <test_setup>XI3</test_setup>
    <pre_requisite>No</pre_requisite>
    <api_or_interface_used>curl -d '{"paramList" : [{"name" : "Device.Ethernet.Interface.1.Upstream"}]}' http://127.0.0.1:10999</api_or_interface_used>
...
"Device.Ethernet.Interface.1.Upstream." to fetch the Upstream device type for an Ethernet Interface.
...
5. TM Unloads tr69Test agent.</automation_approch>
    ...
    <test_script>TR069_Get_DeviceEthernetInterfaceDefaultUpstream_47</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TR069_Get_DeviceEthernetInterfaceDefaultUpstream_47');
...
profilePath = "Device.Ethernet.Interface.1.Upstream"
