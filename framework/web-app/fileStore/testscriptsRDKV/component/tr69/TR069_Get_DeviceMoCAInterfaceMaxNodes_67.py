...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1543</id>
  <version>2</version>
  <name>TR069_Get_DeviceMoCAInterfaceMaxNodes_67</name>
  ...
  <status>FREE</status>
  <synopsis>Objective : To fetch maximum network node capability supported by the interface by querying tr69Hostif through curl. Query string "Device.MoCA.Interafce.1.MaxNodes".	
Test Case ID: CT_TR69_67
Test Case Type: Positive.</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_TR69_67</test_case_id>
    <test_objective>To fetch maximum network node capability supported by the interface by querying tr69Hostif through curl. 
Query string "Device.MoCA.Interafce.1.MaxNodes".
No set operation avaliable for this parameter.</test_objective>
    <test_type>Positive</test_type>
    <test_setup>XI3</test_setup>
    <pre_requisite>No</pre_requisite>
    <api_or_interface_used>curl -d '{"paramList" : [{"name" : "Device.MoCA.Interface.1.MaxNodes"}]}' http://127.0.0.1:10999</api_or_interface_used>
...
"Device.MoCA.Interface.1.MaxNodes" to fetch maximum network node capability supported by the interface.
...
5. TM Unloads tr69Test agent.</automation_approch>
    <except_output>Checkpoint 1. Need to get valid “true/false” on SUCCESS. Empty on FAILURE.</except_output>
    <priority>High</priority>
    <test_stub_interface>libtr69stub.so</test_stub_interface>
    <test_script>TR069_Get_DeviceMoCAInterfaceMaxNodes_67</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TR069_Get_DeviceMoCAInterfaceMaxNodes_67');
...
profilePath = "Device.MoCA.Interface.1.MaxNodes"
