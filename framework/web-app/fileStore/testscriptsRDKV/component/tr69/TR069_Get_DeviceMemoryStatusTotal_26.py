...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1335</id>
  <version>2</version>
  <name>TR069_Get_DeviceMemoryStatusTotal_26</name>
  ...
  <status>FREE</status>
  <synopsis>Objective: To fetch  total physical RAM, in kilobytes, by querying  the tr69Hostif through curl.  Query string "Device.DeviceInfo.MemoryStatus.Total". No set operation avaliable for this parameter.
TestCaseID: CT_TR69_26
TestType: Positive</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_TR69_26</test_case_id>
    <test_objective>To fetch  total physical RAM, in kilobytes, by querying 
the tr69Hostif through curl. 
Query string "Device.DeviceInfo.MemoryStatus.Total".
No set operation avaliable for this parameter.</test_objective>
    <test_type>Positive</test_type>
    <test_setup>XI3</test_setup>
    <pre_requisite>No</pre_requisite>
    <api_or_interface_used>curl -d '{"paramList" : [{"name" : "Device.DeviceInfo.MemoryStatus.Total"}]}' http://127.0.0.1:10999</api_or_interface_used>
...
"Device.DeviceInfo.MemoryStatus.Total" to fetch the total physical RAM, in kilobytes.
...
Checkpoint 2: We can use sysinfo() systemcall to verify correctness of value.</except_output>
    <priority>High</priority>
    <test_stub_interface>libtr69stub.so</test_stub_interface>
    <test_script>TR069_Get_DeviceMemoryStatusTotal_26</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TR069_Get_DeviceMemoryStatusTotal_26');
...
profilePath = "Device.DeviceInfo.MemoryStatus.Total"
