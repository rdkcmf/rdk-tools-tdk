...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id>1561</id>
  <version>2</version>
  <name>TR069_Get_DeviceServicesSTBServiceComponentsVideoDecoderNumberOfEntries_83</name>
  ...
  <status>FREE</status>
  <synopsis>Objective : To fetch number of entries in the VideoDecoder able by querying tr69Hostif through curl. Query string "Device.Services.STBService.1.Components.VideoDecoderNumberOfEntries".
Test Case ID: TC_TR69_83
Test Case Type: Positive.</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_TR69_83</test_case_id>
    <test_objective>To fetch number of entries in the VideoDecoder able by querying tr69Hostif through curl. 
Query string "Device.Services.STBService.1.Components.VideoDecoderNumberOfEntries".
No set operation avaliable for this parameter.</test_objective>
    <test_type>Positive</test_type>
    <test_setup>XI3</test_setup>
    <pre_requisite/>
    <api_or_interface_used>curl -d '{"paramList" : [{"name" : "Device.Services.STBService.1.Components.VideoDecoderNumberOfEntries”}]}' http://127.0.0.1:10999</api_or_interface_used>
...
"Device.Services.STBService.1.Components.VideoDecoderNumberOfEntries" to fetch number of entries in the VideoDecoder table.
3. Tr69Test agent will get the curl response which be a valid unsigned integer value on SUCCESS.
...
5. TM Unloads tr69Test agent.</automation_approch>
    ...
    <test_script>TR069_Get_DeviceServicesSTBServiceComponentsVideoDecoderNumberOfEntries_83</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TR069_Get_DeviceServicesSTBServiceComponentsVideoDecoderNumberOfEntries_83');
