...
Test Case Type: Positive.</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_TR69_77</test_case_id>
    <test_objective>To fetch human-readable name associated with this output by querying tr69Hostif through curl. 
Query string "Device.Services.STBService.1.Components.HDMI.1.Name".
No set operation avaliable for this parameter.</test_objective>
    ...
    <api_or_interface_used>curl -d '{"paramList" : [{"name" : "Device.Services.STBService.1.Components.HDMI.1.Name”}]}' http://127.0.0.1:10999</api_or_interface_used>
...
"Device.Services.STBService.1.Components.HDMI.1.Name" to check the status of HDMI output.
...
5. TM Unloads tr69Test agent.</automation_approch>
    ...
    <test_script>TR069_Get_DeviceServicesSTBServiceComponentsHDMI1Name_77</test_script>
    <skipped>No</skipped>
