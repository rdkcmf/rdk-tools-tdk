...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>CT_TR69_81</test_case_id>
    <test_objective>To fetch the Enhanced Extended Display Information Data (E-EDID) retrieved from the connected HDMI device by querying tr69Hostif through curl. 
Query string "Device.Services.STBService.1.Components.HDMI.1.DisplayDevice.EEDID".
No set operation avaliable for this parameter.</test_objective>
    ...
    <api_or_interface_used>curl -d '{"paramList" : [{"name" : "Device.Services.STBService.1.Components.HDMI.1.DisplayDevice.EEDID”}]}' http://127.0.0.1:10999</api_or_interface_used>
...
"Device.Services.STBService.1.Components.HDMI.1.ResolutionValue" to fetch the Enhanced Extended Display Information Data (E-EDID) retrieved from the connected HDMI device.
...
5. TM Unloads tr69Test agent.</automation_approch>
    ...
    <test_script>TR069_Get_DeviceServicesSTBServiceComponentsHDMI1DisplayDeviceEEDID_81</test_script>
    <skipped>No</skipped>
