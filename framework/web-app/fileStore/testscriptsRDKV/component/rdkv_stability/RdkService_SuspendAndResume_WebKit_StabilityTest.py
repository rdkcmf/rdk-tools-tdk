...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>RdkService_SuspendAndResume_WebKit_StabilityTest</name>
  <primitive_test_id/>
...
6. Revert all values.</automation_approch>
    ...
    <test_script>RdkService_SuspendAndResume_WebKit_StabilityTest</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RdkService_SuspendAndResume_WebKit_StabilityTest');
