...
<xml>
  ...
  <name>RdkService_Loop_URL_StabilityTest</name>
...
3. Revert the plugins</automation_approch>
    ...
    <test_script>RdkService_Loop_URL_StabilityTest</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RdkService_Loop_URL_StabilityTest');
