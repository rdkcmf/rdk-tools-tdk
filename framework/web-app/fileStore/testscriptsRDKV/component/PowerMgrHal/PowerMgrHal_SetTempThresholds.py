...
2.Initialize CPE Power management module</pre_requisite>
    <api_or_interface_used>PLAT_API_SetTempThresholds(float tempHigh, float tempCritical)</api_or_interface_used>
...
3.Invoke PLAT_API_SetTempThresholds API to set the temperature thresholds
4.Based on the API return value and temperature thresholds given by PLAT_API_GetTempThresholds  API update the test status as SUCCESS/FAILURE
5.Unload the module</automation_approch>
    <expected_output>API should set the temperature thresholds</expected_output>
