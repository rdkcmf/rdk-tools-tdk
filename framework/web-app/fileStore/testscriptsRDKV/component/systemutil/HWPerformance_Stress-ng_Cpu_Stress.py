...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    ...
    <api_or_interface_used>Execute stress-ng binary</api_or_interface_used>
    <input_parameters>--cpu 0 --cpu-method all -t 30 --metrics-brief --log-file /tmp/stressng-report.txt</input_parameters>
...
if ("SUCCESS" in sysUtilLoadStatus.upper()):
	     ...
	     App_with_args="stress-ng --cpu 0 --cpu-method all -t 30 --metrics-brief --log-file /tmp/stressng-report.txt;"
	     Parse_log="sh $TDK_PATH/HWPerf_metric_parser.sh stress-ng_CPU_Stress;"
