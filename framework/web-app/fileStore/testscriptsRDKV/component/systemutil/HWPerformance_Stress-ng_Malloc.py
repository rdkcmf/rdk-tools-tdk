...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    ...
    <input_parameters>--malloc 0 -t 30 --metrics-brief --log-file /tmp/stressng-report.txt</input_parameters>
...
if ("SUCCESS" in sysUtilLoadStatus.upper()):
         ...
         App_with_args="stress-ng --malloc 0 -t 30 --metrics-brief --log-file /tmp/stressng-report.txt;"
         Parse_log="sh $TDK_PATH/HWPerf_metric_parser.sh stress-ng_Malloc;"
