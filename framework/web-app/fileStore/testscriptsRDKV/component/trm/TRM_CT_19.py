...
Test Type: Positive</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_TRM_19</test_case_id>
    <test_objective>To validate tuner reservation when duration of reservation media is null</test_objective>
...
2. TM will first invoke “TRMAgent_TunerReserveForLive” and then “TRMAgent_TunerReserveForRecord” in TRMAgent from a terminal. 
3. TRMAgent will connect to TRM Server on IP 127.0.0.1 port 9987 and post HTTP TRM ReserveTuner messages with duration value = 0 (0s) and startTime=0.
4. TRMAgent will connect to TRM Server on IP 127.0.0.1 port 9987 and get the response from the TRM server for both the requests.  
...
TestMgr_TRM_TunerReserveForRecord</test_stub_interface>
    <test_script>TRM_CT_19</test_script>
    <skipped>No</skipped>
