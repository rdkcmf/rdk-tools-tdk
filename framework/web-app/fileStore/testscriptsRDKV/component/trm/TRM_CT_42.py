...
Test Type: Positive</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_TRM_42</test_case_id>
    <test_objective>To validate tuning to channel 6 from terminal 2 when all the tuners are in use from terminal 1</test_objective>
...
4. Verify that TRM allows device 1 to record channel 1 to 4 and tune to channel 5.
5. Verify that TRM allows device 2 to tune to channel 6.
...
TestMgr_TRM_GetAllTunerStates</test_stub_interface>
    <test_script>TRM_CT_42</test_script>
    <skipped>No</skipped>
