...
Test Type: Positive</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_TRM_33</test_case_id>
    <test_objective>To attempt live tune to channel 1 and then cancel recording1 when current state of reservation is (R1-R2-R3-R4-R5) and again live tune to channel 1.</test_objective>
...
4. Verify that TRM allows device 1 to 5 record channels 1 to 5.
...
7. Verify that TRM allows device 1 to tune to channel 1 again.
...
TestMgr_TRM_CancelRecording</test_stub_interface>
    <test_script>TRM_CT_33</test_script>
    <skipped>No</skipped>
