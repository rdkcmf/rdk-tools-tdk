...
Test Type: Positive</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_TRM_13</test_case_id>
    <test_objective>To reserve max number of tuners for live viewing based on board type</test_objective>
...
2. TM will invoke “TRMAgent_TunerReserveForLive” in TRMAgent 5 times with different values of device name and locators. 
3. TRMAgent will connect to TRM Server on IP 127.0.0.1 port 9987 and post 5 HTTP TRM ReserveTuner request message with different locator values.
...
5. Depending on the return values of  ReserveTuner TRMRequest API, TRMAgent will send SUCCESS or FAILURE to TM.</automation_approch>
    <except_output>Checkpoint 1. Check for the return value of tuner reservation for live for all tuners response msg.
...
TestMgr_TRM_TunerReserveForLive</test_stub_interface>
    <test_script>TRM_TunerReserveAllForLive</test_script>
    <skipped>No</skipped>
