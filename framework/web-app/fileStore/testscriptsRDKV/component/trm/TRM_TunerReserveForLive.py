...
Test Type: Positive</synopsis>
  ...
  <test_cases>
    <test_case_id>CT_TRM_05</test_case_id>
    <test_objective>To request tuner reservation for live viewing</test_objective>
...
2. TM will invoke “TRMAgent_TunerReserveForLive” in TRMAgent. 
...
5. Depending on the ReserveTuner TRMRequest API, TRMAgent will send SUCCESS or FAILURE to TM.</automation_approch>
    <except_output>Checkpoint 1. Check for the return value of tuner reservation for live viewing response msg.
...
TestMgr_TRM_TunerReserveForLive</test_stub_interface>
    <test_script>TRM_TunerReserveForLive</test_script>
    <skipped>No</skipped>
...
if "SUCCESS" in result.upper():
    ...
    print "Start live tuning channel 2"
