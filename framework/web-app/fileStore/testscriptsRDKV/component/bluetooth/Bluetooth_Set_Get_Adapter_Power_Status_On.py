...
<xml>
  <id/>
  <version>2</version>
  <name>Bluetooth_Set_Get_Adapter_Power_Status_On</name>
  <primitive_test_id/>
  <primitive_test_name>Bluetooth_GetAdapterPowerStatus</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To set and get the Bluetooth adapter power status as ON</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_BLUETOOTH_03</test_case_id>
    <test_objective>To set and get the bluetooth adapter power status as On.</test_objective>
...
3.Check whether the power status is set as ON using BTRMGR_GetAdapterPowerStatus API</automation_approch>
...
Checkpoint 2.The adapter power status should set to ON</except_output>
    ...
    <test_script>Bluetooth_Set_Get_Adapter_Power_Status_On</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
bluetoothObj.configureTestCase(ip,port,'Bluetooth_Set_Get_Adapter_Power_Status_On');
