...
<xml>
  <id/>
  <version>1</version>
  <name>Bluetooth_Paired_Device_Not_Discover_Unknown</name>
  <primitive_test_id/>
  <primitive_test_name>Bluetooth_PairDevice</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To confirm that the paired device as unknown will not list in discovered devices list again until it is unpaired</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_BLUETOOTH_52</test_case_id>
    <test_objective>To confirm that the paired device as unknown will not list in discovered devices list again until it is unpaired</test_objective>
...
4.Start the device discovery in DUT as unknown
...
7.Pair with the bluetooth emulator as unknown
...
10.Unpair the bluetooth emulator as unknown
...
Checkpoint 4 After starting and stoping the discovery again the discovered devicers list should not contain the already paired device</except_output>
    ...
    <test_script>Bluetooth_Paired_Device_Not_Discover_Unknown</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
bluetoothObj.configureTestCase(ip,port,'Bluetooth_Paired_Device_Not_Discover_Unknown');
