...
<xml>
  <id/>
  <version>1</version>
  <name>Bluetooth_External_Paired_Device_Properties</name>
  <primitive_test_id/>
  <primitive_test_name>Bluetooth_GetDeviceProperties</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To check the paired device properties when the pair request came from external device</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_BLUETOOTH_56</test_case_id>
    <test_objective>To check the paired device properties when the pair request came from external device</test_objective>
...
7.Unpair the bluetooth emulator
</automation_approch>
...
Checkpoint 3 After Unpair the bluetooth emulator  should be removed from the paired devices list of DUT</except_output>
    ...
    <test_script>Bluetooth_External_Paired_Device_Properties</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
bluetoothObj.configureTestCase(ip,port,'Bluetooth_External_Paired_Device_Properties');
