...
<xml>
  ...
  <status>FREE</status>
  <synopsis>To check whether discoverable  devices are listed in the discovered devices list when the decvice type is audio output</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_BLUETOOTH_33</test_case_id>
    <test_objective>To check whether discoverable  devices are listed in the discovered devices list when the decvice type is audio output</test_objective>
...
6.Stop the device discovery with the decvice type as audio output after 30 seconds
