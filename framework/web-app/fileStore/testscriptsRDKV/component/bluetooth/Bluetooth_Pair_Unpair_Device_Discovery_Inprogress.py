...
<xml>
  <id/>
  <version>2</version>
  <name>Bluetooth_Pair_Unpair_Device_Discovery_Inprogress</name>
  <primitive_test_id/>
  <primitive_test_name>Bluetooth_PairDevice</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To check whether pair and un pair happens during the device discovery</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_BLUETOOTH_23</test_case_id>
    <test_objective>To check whether pair and unpair happens during the device discovery</test_objective>
...
5.Check the discovered devices list in DUT and confirm the bluetooth emulator adapter name is there in the list
6.Pair with the bluetooth emulator when the device discovery is in progress
7.Check the paired devices list in DUT and confirm the bluetooth emulator adapter name is there in the list
8.Unpair the bluetooth emulator
9.Check the paired devices list in DUT and confirm the bluetooth emulator adapter name is NOT there in the list</automation_approch>
...
Checkpoint 4 After unpair, the bluetooth emulator name should NOT be there in the paired devices list of DUT</except_output>
    ...
    <test_script>Bluetooth_Pair_Unpair_Device_Discovery_Inprogress</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
bluetoothObj.configureTestCase(ip,port,'Bluetooth_Pair_Unpair_Device_Discovery_Inprogress');
