...
<xml>
  <id/>
  <version>7</version>
  <name>Bluetooth_Discoverable_On_List_Discovered_Devices_Audio_Input</name>
  <primitive_test_id/>
  <primitive_test_name>Bluetooth_GetDiscoveredDevices</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To check whether discoverable  devices are listed in the discovered devices list when the decvice type is audio input</synopsis>
  <groups_id/>
  ...
  <test_cases>
    ...
    <test_objective>To check whether discoverable  devices are listed in the discovered devices list when the decvice type is audio input</test_objective>
...
5.Start the device discovery in DUT with Audio_Intput as param
6.Stop the device discovery with the decvice type as audio input after 30 seconds
...
Checkpoint 2.The bluetooth emulator name should be there in the discovered devices list of DUT</except_output>
    ...
    <test_script>Bluetooth_Discoverable_On_List_Discovered_Devices_Audio_Input</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
bluetoothObj.configureTestCase(ip,port,'Bluetooth_Discoverable_On_List_Discovered_Devices_Audio_Input');
