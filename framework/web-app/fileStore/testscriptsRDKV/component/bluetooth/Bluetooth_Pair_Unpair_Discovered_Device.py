...
<xml>
  <id/>
  <version>4</version>
  <name>Bluetooth_Pair_Unpair_Discovered_Device</name>
  <primitive_test_id/>
  <primitive_test_name>Bluetooth_PairDevice</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To pair and unpair with a discovered device</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_BLUETOOTH_14</test_case_id>
    <test_objective>To pair and unpair with a discovered device</test_objective>
...
9.Unpair the bluetooth emulator
10.Check the paired devices list in DUT and confirm the bluetooth emulator adapter name is NOT there in the list
</automation_approch>
...
Checkpoint 4 After unpair, the bluetooth emulator name should NOT be there in the paired devices list of DUT</except_output>
    ...
    <test_script>Bluetooth_Pair_Unpair_Discovered_Device</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
bluetoothObj.configureTestCase(ip,port,'Bluetooth_Pair_Unpair_Discovered_Device');
