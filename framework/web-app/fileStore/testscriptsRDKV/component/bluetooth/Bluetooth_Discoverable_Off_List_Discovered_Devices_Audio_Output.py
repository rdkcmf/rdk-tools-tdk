...
Checkpoint 3 The bluetooth emulator name should NOT be there in the discovered devices list of DUT after the discoverable status of bluetooth emulator turned OFF</except_output>
    ...
    <test_script>Bluetooth_Discoverable_Off_List_Discovered_Devices_Audio_Output</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
bluetoothObj.configureTestCase(ip,port,'Bluetooth_Discoverable_Off_List_Discovered_Devices_Audio_Output');
