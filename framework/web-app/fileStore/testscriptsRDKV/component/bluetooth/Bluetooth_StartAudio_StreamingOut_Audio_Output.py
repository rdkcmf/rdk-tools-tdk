...
<xml>
  <id/>
  <version>2</version>
  <name>Bluetooth_StartAudio_StreamingOut_Audio_Output</name>
  <primitive_test_id/>
  <primitive_test_name>Bluetooth_StartAudioStreamingOut</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To Start the audio streaming out with device type as audio output</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_BLUETOOTH_40</test_case_id>
    <test_objective>To Start the audio streaming out with device type as audio output</test_objective>
...
Checkpoint 6 After unpair, the bluetooth emulator name should NOT be there in the paired devices list of DUT</except_output>
    ...
    <test_script>Bluetooth_StartAudio_StreamingOut_Audio_Output</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
bluetoothObj.configureTestCase(ip,port,'Bluetooth_StartAudio_StreamingOut_Audio_Output');
