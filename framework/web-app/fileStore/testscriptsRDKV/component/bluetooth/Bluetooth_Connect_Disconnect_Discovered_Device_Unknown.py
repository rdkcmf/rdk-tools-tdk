...
<xml>
  <id/>
  <version>3</version>
  <name>Bluetooth_Connect_Disconnect_Discovered_Device_Unknown</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>CT_BLUETOOTH_29</test_case_id>
...
9.Connect with the device with Unknown as the parameter
...
Checkpoint 6 After unpair, the bluetooth emulator name should NOT be there in the paired devices list of DUT</except_output>
    ...
    <test_script>Bluetooth_Connect_Disconnect_Discovered_Device_Unknown</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
bluetoothObj.configureTestCase(ip,port,'Bluetooth_Connect_Disconnect_Discovered_Device_Unknown');
