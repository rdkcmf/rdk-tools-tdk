...
<xml>
  <id/>
  <version>3</version>
  <name>Bluetooth_StartAudio_StreamingOut_Audio_Input</name>
  <primitive_test_id/>
  <primitive_test_name>Bluetooth_StartAudioStreamingOut</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>To Start the audio streaming out with device type as audio input</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>CT_BLUETOOTH_39</test_case_id>
    <test_objective>To Start the audio streaming out with device type as audio input</test_objective>
...
11.Check the connected devices list in DUT and confirm the bluetooth emulator adapter name is there in the list
12.Stop the audio streaming out and check audio streaming out is stopped or not then unpair the bluetooth emulator with the DUT</automation_approch>
...
Checkpoint 4 Check whether the audio streaming out is started or not 
...
Checkpoint 6 After unpair, the bluetooth emulator name should NOT be there in the paired devices list of DUT</except_output>
    ...
    <test_script>Bluetooth_StartAudio_StreamingOut_Audio_Input</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
bluetoothObj.configureTestCase(ip,port,'Bluetooth_StartAudio_StreamingOut_Audio_Input');
