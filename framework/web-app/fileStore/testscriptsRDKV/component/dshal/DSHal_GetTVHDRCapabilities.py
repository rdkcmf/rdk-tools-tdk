...
dsObj.configureTestCase(ip,port,'DSHal_GetTVHDRCapabilities');

dsloadModuleStatus = dsObj.getLoadModuleResult();
print "[devicesettings LIB LOAD STATUS]  :  %s" %dsloadModuleStatus;

#Get the result of connection with test component and STB
loadModuleStatus = obj.getLoadModuleResult();
print "[LIB LOAD STATUS]  :  %s" %loadModuleStatus;

if "SUCCESS" in loadModuleStatus.upper() and "SUCCESS" in dsloadModuleStatus.upper():
    ...
    if "SUCCESS" in result:
        ...
        if isDisplayConnected == "TRUE":
            ...
            if expectedResult in actualResult:
                ...
                print "\nTEST STEP2 : Get the HDR capabilities supported by the TV using dsGetTVHDRCapabilities API"
    ...
    dsObj.setLoadModuleStatus(dsloadModuleStatus.upper());
