...
<xml>
  ...
  <name>RDKV_Profiling_Execute_Systemd_Bootchart</name>
  <!-- If you are adding a new script you can specify the script name. Script Name should be unique same as this file name with out .py extension -->
  <primitive_test_id> </primitive_test_id>
  <!-- Do not change primitive_test_id if you are editing an existing script. -->
  <primitive_test_name>rdkv_profiling_systemd_bootchart_execute</primitive_test_name>
  <!--  -->
  ...
  <test_cases>
    ...
    <test_script>RDKV_Profiling_Execute_Systemd_Bootchart</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_Profiling_Execute_Systemd_Bootchart');
...
if expectedResult in result.upper():
    ...
    if expectedResult in result:
        ...
        #Get the result of systemd_bootchart tool
        tdkTestObj = obj.createTestStep("rdkv_profiling_systemd_bootchart_execute")
        ...
        if "SUCCESS" in result:
            print "\nsystemd_bootchart tool execution success and transferred the log"
            tdkTestObj.setResultStatus("SUCCESS")
        else:
            print "\nsystemd_bootchart tool execution or log transfer failed"
