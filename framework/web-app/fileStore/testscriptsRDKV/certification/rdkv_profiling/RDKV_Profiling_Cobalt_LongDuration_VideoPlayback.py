...
3. Check video playback using decoder proc entries for every 5 minutes if decoder proc entries are available
...
if expectedResult in result.upper():
    ...
    if status == "SUCCESS" and validation_dict != {} and cobalt_test_url != "":
        ...
        time.sleep(30)
        #Validate system wide profiling data before playing cobalt long duration videoplayback
        end_datetime_string = str(datetime.utcnow()).split('.')[0]
        print "\n Validating system wide profiling metrics from grafana before playing cobalt long duration videoplayback\n"
        ...
        #Validate process wise profiling data before playing cobalt long duration videoplayback
        print "\n Validating process wise profiling metrics from grafana before playing cobalt long duration videoplayback\n"
            ...
            if cobalt_status == 'resumed' and expectedResult in result:
                ...
                if(cobalt_result == expectedResult):
                    ...
                    if "SUCCESS" == (result1 and result2):
                        ...
                        if result == "SUCCESS":
                            #Validate system wise profiling data
