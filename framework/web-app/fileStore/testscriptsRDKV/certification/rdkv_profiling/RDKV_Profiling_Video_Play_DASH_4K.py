...
<xml>
  ...
  <name>RDKV_Profiling_Video_Play_DASH_4K</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>The objective of this test is to validate profiling data after performing video playback of dash 4k content using lightning video player app (DASHJS)</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>RDKV_PROFILING_18</test_case_id>
    <test_objective>The objective of this test is to validate profiling data after performing video playback of dash 4k content using lightning video player app (DASHJS)</test_objective>
...
8. Revert the Webkit instance URL and plugin status.</automation_approch>
    ...
    <test_script>RDKV_Profiling_Video_Play_DASH_4K</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_Profiling_Video_Play_DASH_4K');
...
if expectedResult in result.upper():
    ...
    time.sleep(30)
    #Validate system wide profiling data before playing Dash 4k video
    end_datetime_string = str(datetime.utcnow()).split('.')[0]
    print "\n Validating system wide profiling mettrics from grafana before playing Dash 4k video \n"
    ...
    #Validate process wise profiling data before playing Dash 4k video
    print "\n Validating process wise profiling metrics from grafana before playing Dash 4k video \n"
    ...
    if expectedResult in result and expectedResult in config_status:
        ...
        if is_front:
            ...
            videoURL  = video_src_url_4k_dash
            ...
            #url=<video_4k_url>.mpd&operations=close(60)&autotest=true&type=dash
