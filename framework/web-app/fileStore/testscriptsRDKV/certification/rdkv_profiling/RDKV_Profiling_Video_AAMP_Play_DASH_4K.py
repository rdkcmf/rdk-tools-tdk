...
<xml>
  ...
  <name>RDKV_Profiling_Video_AAMP_Play_DASH_4K</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>The objective of this test is to validate profiling data after performing video playback of dash 4k content using lightning uve aamp player app</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>RDKV_PROFILING_15</test_case_id>
    <test_objective>The objective of this test is to validate profiling data after performing video playback of dash 4k content using lightning uve aamp player app</test_objective>
...
8. Revert the Webkit instance URL and plugin status.</automation_approch>
    ...
    <test_script>RDKV_Profiling_Video_AAMP_Play_DASH_4K</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_Profiling_Video_AAMP_Play_DASH_4K');
...
if expectedResult in result.upper():
    ...
    time.sleep(30)
    #Validate system wide profiling data before playing AAMP video Dash 4k
    end_datetime_string = str(datetime.utcnow()).split('.')[0]
    print "\n Validating system wide profiling mettrics from grafana before  playing AAMP video Dash 4k \n"
    ...
    #Validate process wise profiling data before  playing AAMP video Dash 4k
    print "\n Validating process wise profiling metrics from grafana before  playing AAMP video Dash 4k\n"
    ...
    if expectedResult in result and expectedResult in config_status:
        ...
        if is_front:
            ...
            #url=<video_4k_url>.mpd&operations=close(60)&autotest=true
