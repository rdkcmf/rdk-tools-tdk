...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>RDKV_CERT_PACS_AmazonPrime_PlayNext</name>
  <primitive_test_id/>
  <primitive_test_name>rdkservice_setValue</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>The objective of this test is to launch Amazon prime and navigate through videos,select next video and play.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>RDKV_PERFORMANCE_44</test_case_id>
    <test_objective>The objective of this test is to launch Amazon prime and navigate through videos, select next video and play.</test_objective>
...
4. Navigate through videos using generateKey method and click OK to play a video.
5. Validate video playback
</automation_approch>
    <expected_output>User must be able to navigate through videos and play the selected video</expected_output>
    <priority>High</priority>
    <test_stub_interface>rdkv_performance</test_stub_interface>
    <test_script>RDKV_CERT_PACS_AmazonPrime_PlayNext</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_PACS_Amazon_PlayNext');
            ...
            if expectedResult in zorder_status:
                ...
                if movedToFront:
                    ...
                    if expectedResult in result:
                        ...
                        navigate_params = '{"keys":[ {"keyCode": 40,"modifiers": [],"delay":1.0},{"keyCode": 40,"modifiers": [],"delay":1.0},{"keyCode": 39,"modifiers": [],"delay":1.0},{"keyCode": 13,"modifiers": [],"delay":2.0},{"keyCode": 13,"modifiers": [],"delay":3.0}]}'
                        tdkTestObj = obj.createTestStep('rdkservice_setValue')
                        tdkTestObj.addParameter("method","org.rdk.RDKShell.1.generateKey")
                        tdkTestObj.addParameter("value",navigate_params)
                        tdkTestObj.executeTestCase(expectedResult)
                        ...
                        if expectedResult in amazon_result:
                            ...
                            print "\n Error while navigating through videos \n"
                            tdkTestObj.setResultStatus("FAILURE")
                    else:
