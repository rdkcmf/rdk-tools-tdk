...
<xml>
  ...
  <name>RdkService_PremiumApp_PlayPause_CobaltTest</name>
...
8. Revert all values.</automation_approch>
    ...
    <test_script>RdkService_PremiumApp_PlayPause_CobaltTest</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RdkService_PremiumApp_PlayPause_CobaltTest');
