...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>RDKService_FunctionalPerformance_WiFi_TimeTo_UILaunch</name>
  <primitive_test_id/>
...
8. Revert the interface </automation_approch>
    ...
    <test_script>RDKService_FunctionalPerformance_WiFi_TimeTo_UILaunch</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKService_FunctionalPerformance_WiFi_TimeTo_UILaunch');
