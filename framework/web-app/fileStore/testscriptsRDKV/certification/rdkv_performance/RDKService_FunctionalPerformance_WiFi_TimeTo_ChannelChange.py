...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>RDKService_FunctionalPerformance_WiFi_TimeTo_ChannelChange</name>
  <primitive_test_id/>
...
Channel change time should be within the expected limit</expected_output>
    ...
    <test_script>RDKService_FunctionalPerformance_WiFi_TimeTo_ChannelChange</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKService_FunctionalPerformance_WiFi_TimeTo_ChannelChange');
