...
<xml>
  ...
  <name>RdkService_FunctionalPerformance_InterfaceUp</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>The objective of the test is to find the time to get the eth0/wlan0 interface IP after reboot</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
4. Calculate output by finding the difference between timestamp in step 4 and time got in step 1.</automation_approch>
    ...
    <test_script>RdkService_FunctionalPerformance_InterfaceUp</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RdkService_FunctionalPerformance_InterfaceUp');
