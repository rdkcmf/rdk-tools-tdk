...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>RDKService_PremiumApp_Cobalt_WiFi_VideoPlayback_Performance</name>
  <primitive_test_id/>
...
The CPU load and memory usage must be within the expected range.
    ...
    <test_script>RDKService_PremiumApp_Cobalt_WiFi_VideoPlayback_Performance</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKService_PremiumApp_Cobalt_WiFi_VideoPlayback_Performance');
