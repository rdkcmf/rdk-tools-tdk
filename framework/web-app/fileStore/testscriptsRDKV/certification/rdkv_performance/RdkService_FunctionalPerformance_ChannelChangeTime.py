...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>RdkService_FunctionalPerformance_ChannelChangeTime</name>
  <primitive_test_id/>
...
7. Revert all values
    ...
    <test_script>RdkService_FunctionalPerformance_ChannelChangeTime</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RdkService_FunctionalPerformance_ChannelChangeTime');
