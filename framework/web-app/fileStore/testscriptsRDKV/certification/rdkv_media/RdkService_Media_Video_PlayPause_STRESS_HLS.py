...
<xml>
  ...
  <name>RdkService_Media_Video_PlayPause_STRESS_HLS</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test Script to launch a lightning Video player application via Webkit Browser and perform video play pause operations of hls content continuously for given number of times</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    ...
    <test_objective>Test Script to launch a lightning Video player application via Webkit Browser and perform video play pause operations of hls content continuously for given number of times</test_objective>
...
7. Revert all values</automation_approch>
    ...
    <test_script>RdkService_Media_Video_PlayPause_STRESS_HLS</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RdkService_Media_Video_PlayPause_STRESS_HLS')
