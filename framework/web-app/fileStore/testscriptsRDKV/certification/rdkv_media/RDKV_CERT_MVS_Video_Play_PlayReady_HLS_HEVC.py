...
<xml>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test Script to launch a lightning Video player application via Webkit Browser and perform video play operation of PlayReady DRM protected HEVC codec hls stream for few minutes and close the player</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    ...
    <test_objective>Test Script to launch a lightning Video player application via Webkit Browser and perform video play operation of PlayReady DRM protected HEVC codec hls stream for few minutes and close the player		</test_objective>
