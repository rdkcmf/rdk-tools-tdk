...
<xml>
  ...
  <name>RDKV_CERT_MVS_Video_Play_H264</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test Script to launch a lightning Video player application via Webkit Browser and perform video play operation of H.264 codec stream for few minutes and close the player</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    ...
    <test_objective>Test Script to launch a lightning Video player application via Webkit Browser and perform video play operation of H.264 codec stream for few minutes and close the player</test_objective>
...
video_src_url_h264: string
h264_url_type:string
...
4. App starts playing the h.264 stream video and closes the player after the provided duration.
...
7. Revert all values</automation_approch>
    ...
    <test_script>RDKV_CERT_MVS_Video_Play_H264</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_MVS_Video_Play_H264')
...
if expectedResult in result.upper():
    ...
    if pre_requisite_status == "SUCCESS":
        ...
        videoURL  = MediaValidationVariables.video_src_url_h264
        ...
        setURLArgument("type",MediaValidationVariables.h264_url_type)
        ...
        #url=<video_h264_url>.mpd&operations=close(60)&autotest=true&type=dash
