...
<xml>
  ...
  <name>RDKV_CERT_MVS_Video_UVE_Play_Widevine_DASH_H264</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test Script to launch a lightning UVE player application via Webkit Browser and perform video play operation of Widevine DRM protected H.264 codec dash stream for few minutes and close the player</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    ...
    <test_objective>Test Script to launch a lightning UVE player application via Webkit Browser and perform video play operation of Widevine DRM protected H.264 codec dash stream for few minutes and close the player</test_objective>
...
7. Revert all values</automation_approch>
    ...
    <test_script>RDKV_CERT_MVS_Video_UVE_Play_Widevine_DASH_H264</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_MVS_Video_UVE_Play_Widevine_DASH_H264')
