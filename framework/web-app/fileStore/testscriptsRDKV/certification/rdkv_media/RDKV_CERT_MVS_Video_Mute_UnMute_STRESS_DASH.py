...
<xml>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test Script to launch a lightning Video player application via Webkit instance to play dash video content and perform mute, unmute operations repeatedly for given number of times</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    ...
    <test_objective>Test Script to launch a lightning Video player application via Webkit instance to play dash video content and perform mute, unmute operations repeatedly for given number of times</test_objective>
