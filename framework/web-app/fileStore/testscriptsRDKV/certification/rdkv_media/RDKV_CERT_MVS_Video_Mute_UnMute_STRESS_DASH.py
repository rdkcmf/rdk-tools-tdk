...
<xml>
  ...
  <name>RDKV_CERT_MVS_Video_Mute_UnMute_STRESS_DASH</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test Script to launch a lightning Video player application via Webkit Browser to play dash video content and perform mute, unmute operations repeatedly for given number of times</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    ...
    <test_objective>Test Script to launch a lightning Video player application via Webkit Browser to play dash video content and perform mute, unmute operations repeatedly for given number of times</test_objective>
...
3. Load the player app url with the operations to be performed, mute and unmute with given interval.
...
7. Revert all values</automation_approch>
    ...
    <test_script>RDKV_CERT_MVS_Video_Mute_UnMute_STRESS_DASH</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_MVS_Video_Mute_UnMute_STRESS_DASH')
            ...
            if expectedResult in result:
                ...
                if new_url in video_test_url and expectedResult in result:
                    ...
                    while True:
                        ...
                        if "Observed Event: volumechange" in console_log and validation_dict["proc_check"]:
