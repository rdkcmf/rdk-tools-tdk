...
<xml>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test Script to launch a lightning Video player application via Webkit Browser and perform video fast forward operation in 16x speed for few seconds, continue video play of dash content and close the player</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    ...
    <test_objective>Test Script to launch a lightning Video player application via Webkit Browser and perform video fast forward operation in 16x speed for few seconds, continue video play of dash content and close the player</test_objective>
...
7. Revert all values</automation_approch>
    ...
    <test_script>RDKV_CERT_MVS_Video_FF16X_DASH</test_script>
    <skipped>No</skipped>
...
if expectedResult in result.upper():
    ...
    setURLArgument("options","useDashlib("+str(usedashlib)+"),checkInterval(5)")
