...
<xml>
  ...
  <name>RdkService_Media_Video_FF_STRESS_DASH</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test Script to launch a lightning Video player application via Webkit Browser and perform video fast forward operation of dash content repeatedly for given number of times</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    ...
    <test_objective>Test Script to launch a lightning Video player application via Webkit Browser and perform video fast forward operation of dash content repeatedly for given number of times</test_objective>
...
7. Revert all values</automation_approch>
    ...
    <test_script>RdkService_Media_Video_FF_STRESS_DASH</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RdkService_Media_Video_FF_STRESS_DASH')
...
if expectedResult in result.upper():
    ...
    #url=<video_url>.mpd&operations=fastfwd(10),repeat(3),playnow(10),repeat(1),fastfwd(10),repeat(3),playnow(10)&autotest=true&type=dash
