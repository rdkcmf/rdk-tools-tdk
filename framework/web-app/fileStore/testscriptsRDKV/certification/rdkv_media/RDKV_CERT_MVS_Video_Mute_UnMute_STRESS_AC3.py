...
<xml>
  ...
  <name>RDKV_CERT_MVS_Video_Mute_UnMute_STRESS_AC3</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Test Script to launch a lightning Video player application via Webkit instance to play ac3 codec video content and perform mute, unmute operations repeatedly for given number of times</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    ...
    <test_objective>Test Script to launch a lightning Video player application via Webkit instance to play ac3 codec video content and perform mute, unmute operations repeatedly for given number of times		</test_objective>
...
7. Revert all values</automation_approch>
    ...
    <test_script>RDKV_CERT_MVS_Video_Mute_UnMute_STRESS_AC3</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKV_CERT_MVS_Video_Mute_UnMute_STRESS_AC3')
