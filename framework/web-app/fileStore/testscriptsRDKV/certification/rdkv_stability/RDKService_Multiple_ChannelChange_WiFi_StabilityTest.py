...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>RDKService_Multiple_ChannelChange_WiFi_StabilityTest</name>
  <primitive_test_id/>
...
CPU load and memory usage must be within the expected limit</expected_output>
    ...
    <test_script>RDKService_Multiple_ChannelChange_WiFi_StabilityTest</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKService_Multiple_ChannelChange_WiFi_StabilityTest');
