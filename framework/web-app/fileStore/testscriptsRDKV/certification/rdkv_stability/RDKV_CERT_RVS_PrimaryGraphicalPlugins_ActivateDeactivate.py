...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>RDKV_CERT_RVS_PrimaryGraphicalPlugins_ActivateDeactivate</name>
  <primitive_test_id/>
  <primitive_test_name>rdkservice_getCPULoad</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>The objective of this test is to activate and deactivate primary graphical plugins(WebKitBrowser, Cobalt) for given number of times.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    ...
    <test_objective>The objective of this test is to activate and deactivate primary grapgical plugins(WebKitBrowser, Cobalt) for given number of times.</test_objective>
...
2. Change the status of plugins in a loop,using RDKShell launch method and destroy method.
...
4. Revert the plugins status after loop.</automation_approch>
    ...
    <test_script>RDKV_CERT_RVS_PrimaryGraphicalPlugins_ActivateDeactivate</test_script>
    <skipped>No</skipped>
