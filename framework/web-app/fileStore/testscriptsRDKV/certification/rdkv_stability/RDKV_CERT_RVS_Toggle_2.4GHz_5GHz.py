                ...
                if connect_wifi_status == "SUCCESS":
                    ...
                    if (result == "SUCCESS"):
                        ...
                        if is_high_cpuload == "YES" or expectedResult not in result:
                            ...
                            tdkTestObj.setResultStatus("SUCCESS")
                            print "\n CPU load is {}% during iteration:{}".format(cpuload,count+1)
                    else:
                        tdkTestObj.setResultStatus("FAILURE")
                    ...
                    if (result == "SUCCESS"):
                        ...
                        if is_high_memory_usage == "YES" or expectedResult not in result:
                            print "\n Memory usage is high :{}% during iteration: {}".format(memory_usage,count+1)
                            tdkTestObj.setResultStatus("FAILURE")
                            break
                        else:
                            tdkTestObj.setResultStatus("SUCCESS")
                            print "\n Memory usage is {}% during iteration: {}".format(memory_usage,count+1)
                    else:
