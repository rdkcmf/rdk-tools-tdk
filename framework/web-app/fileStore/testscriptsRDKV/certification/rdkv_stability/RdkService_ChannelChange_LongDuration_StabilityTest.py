...
<xml>
  ...
  <name>RdkService_ChannelChange_LongDuration_StabilityTest</name>
...
6.Revert all values before exiting</automation_approch>
    ...
    <test_script>RdkService_ChannelChange_LongDuration_StabilityTest</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RdkService_ChannelChange_LongDuration_StabilityTest');
