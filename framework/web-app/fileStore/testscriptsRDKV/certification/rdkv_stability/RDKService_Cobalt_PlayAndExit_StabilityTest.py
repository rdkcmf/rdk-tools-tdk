...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>RDKService_Cobalt_PlayAndExit_StabilityTest</name>
  <primitive_test_id/>
...
8. Revert the values.</automation_approch>
    ...
    <test_script>RDKService_Cobalt_PlayAndExit_StabilityTest</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKService_Cobalt_LaunchAndExit_StabilityTest');
