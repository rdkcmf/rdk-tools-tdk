...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>RDKService_ScreenResolution_StabilityTest</name>
  <primitive_test_id/>
...
The images of different resolutions should be different.</expected_output>
    ...
    <test_script>RDKService_ScreenResolution_StabilityTest</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'RDKService_ScreenResolution_StabilityTest');
