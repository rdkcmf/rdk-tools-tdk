...
if "SUCCESS" in sysutilloadModuleStatus.upper():
    ...
    #Sample command = "mediapipelinetests test_latency <DASH_STREAM_URL> checkavstatus=yes timeout=20 latencyThreshold=100"
    ...
    if expectedResult in actualresult.upper() and output:
        ...
        if expectedResult in executionStatus:
            ...
            print "Latency retrieved was optimal for DASH playback"
            print "Mediapipeline test executed successfully"
        else:
            tdkTestObj.setResultStatus("FAILURE")
            print "Latency retrieved was not optimal for DASH playback"
    else:
        tdkTestObj.setResultStatus("FAILURE")
