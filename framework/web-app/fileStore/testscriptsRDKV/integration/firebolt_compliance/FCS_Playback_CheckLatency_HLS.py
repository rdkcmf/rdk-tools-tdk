...
if "SUCCESS" in sysutilloadModuleStatus.upper():
    ...
    #Sample command = "mediapipelinetests test_latency <HLS_STREAM_URL> checkavstatus=yes timeout=20 latencyThreshold=100"
    ...
    if expectedResult in actualresult.upper() and output:
        ...
        if expectedResult in executionStatus:
            ...
            print "Latency retrieved was optimal for HLS playback"
            print "Mediapipeline test executed successfully"
        else:
            tdkTestObj.setResultStatus("FAILURE")
            print "Latency retrieved was not optimal for HLS playback"
    else:
        tdkTestObj.setResultStatus("FAILURE")
