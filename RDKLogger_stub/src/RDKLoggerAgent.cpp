...
string g_tdkPath = getenv("TDK_LOG_PATH");
...
bool CheckLog(const char* search)
{
    ...
    DEBUG_PRINT(DEBUG_TRACE, "Redirecting rdklogger journal logging to tdk log file\n");
    FILE *fp = NULL;
    char readRespBuff[512] = { '\0' };
    string cmd= "journalctl -a -u tdk";
