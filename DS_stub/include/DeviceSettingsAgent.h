		...
		DeviceSettingsAgent(TcpSocketServer &ptrRpcServer) : AbstractServer <DeviceSettingsAgent>(ptrRpcServer)
                {
                  ...
                  this->bindAndAddMethod(Procedure("TestMgr_DS_AOP_setCompression", PARAMS_BY_NAME, JSON_STRING,"port_name", JSON_STRING,"compression_format", JSON_STRING,NULL), &DeviceSettingsAgent::AOP_setCompression);
